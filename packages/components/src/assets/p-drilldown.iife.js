      ...
      @keyframes slide-up-mobile {
        ...
        dialog {
          ...
          transition: visibility 0s linear
            ...
            overlay var(--p-transition-duration, var(--p-duration-md)) var(--p-ease-out)
              allow-discrete,
            background var(--p-transition-duration, var(--p-duration-md))
              var(--p-ease-out),
            backdrop-filter var(--p-transition-duration, var(--p-duration-md))
              var(--p-ease-out),
            -webkit-backdrop-filter var(--p-transition-duration, var(--p-duration-md)) var(--p-ease-out);
        }
        :host([open]) dialog {
          visibility: inherit;
          ...
          transition: background var(--p-transition-duration, var(--p-duration-lg))
              var(--p-ease-in),
            backdrop-filter var(--p-transition-duration, var(--p-duration-lg))
              var(--p-ease-in),
            -webkit-backdrop-filter var(--p-transition-duration, var(--p-duration-lg)) var(--p-ease-in);
        }
        dialog::backdrop {
          display: none;
        }
        .drawer {
          ...
          transition: opacity var(--p-transition-duration, var(--p-duration-sm))
              var(--p-ease-out),
            transform var(--p-transition-duration, var(--p-duration-sm))
              var(--p-ease-out);
        }
        :host([open]) .drawer {
          opacity: 1;
          ...
          transition: opacity var(--p-transition-duration, var(--p-duration-md))
              var(--p-ease-in),
            transform var(--p-transition-duration, var(--p-duration-md))
              var(--p-ease-in);
        }
        ...
        @media (min-width: 760px) {
          :host([data-primary]) slot {
            ...
            animation: slide-up-desktop
              var(--p-animation-duration, var(--p-duration-md)) var(--p-ease-in-out);
          }
          :host([data-secondary]:not([data-primary]))
            ::slotted(*:not([primary], [cascade])) {
            display: none !important;
          }
          :host([data-secondary]) .drawer {
            width: calc(clamp(338px, 210px + 18vw, 640px) * 2);
            grid-template: var(--p-spacing-fluid-md) auto minmax(0, 1fr) / repeat(
                2,
                var(--p-spacing-fluid-lg) minmax(0, 1fr) var(--p-spacing-fluid-lg)
              );
            background: linear-gradient(
              90deg,
              var(--_p-drilldown-b) 0%,
              var(--_p-drilldown-b) 50%,
              var(--_p-drilldown-c) 50%,
              var(--_p-drilldown-c) 100%
            );
          }
          :host([data-secondary]) .drawer:dir(rtl) {
            background: linear-gradient(
              90deg,
              var(--_p-drilldown-c) 0%,
              var(--_p-drilldown-c) 50%,
              var(--_p-drilldown-b) 50%,
              var(--_p-drilldown-b) 100%
            );
          }
        ...
        @media (max-width: 759px) {
          ...
          :host([data-primary]:not([data-secondary])) slot {
            animation: slide-up-mobile var(--p-animation-duration, var(--p-duration-md))
              var(--p-ease-in-out);
          }
          ...
          .drawer {
            grid-template:
              var(--p-spacing-fluid-md) auto var(--p-spacing-fluid-lg) minmax(0, 1fr)
              / var(--p-spacing-fluid-lg) auto minmax(0, 1fr) auto var(--p-spacing-fluid-lg);
            background: var(--_p-drilldown-b);
          }
          .drawer::after,
          .drawer::before {
