...
\f\r"'\`<>=]|("|')|))|$)`, "g");
  ...
  // ../../components/mitosis/input-email/output/lit/InputEmail.ts
...
`;
  ...
  __decorateClass([
    n4()
  ], LitInputEmail.prototype, "name", 2);
  __decorateClass([
    n4()
