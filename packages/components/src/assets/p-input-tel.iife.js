...
\f\r"'\`<>=]|("|')|))|$)`, "g");
  ...
  // ../../components/mitosis/input-tel/output/lit/InputTel.ts
  var LitInputTel = class extends i4 {
    get cssText() {
      const minWidth = {
        xs: 480,
        s: 760,
    ...
    get indicatorIconSrc() {
      return "http://localhost:3001/icons/phone.f4f774b.svg";
    }
    updated() {
...
`;
  __decorateClass([
    n4()
  ], LitInputTel.prototype, "disabled", 2);
  __decorateClass([
    n4()
  ], LitInputTel.prototype, "loading", 2);
  __decorateClass([
    n4()
  ], LitInputTel.prototype, "compact", 2);
  __decorateClass([
    n4({ attribute: "read-only" })
  ], LitInputTel.prototype, "readOnly", 2);
  __decorateClass([
    n4()
  ], LitInputTel.prototype, "indicator", 2);
  __decorateClass([
    n4()
  ], LitInputTel.prototype, "state", 2);
  __decorateClass([
    n4()
  ], LitInputTel.prototype, "message", 2);
  __decorateClass([
    n4({ attribute: "hide-label" })
  ], LitInputTel.prototype, "hideLabel", 2);
  __decorateClass([
    n4()
  ], LitInputTel.prototype, "label", 2);
  __decorateClass([
    n4()
  ], LitInputTel.prototype, "name", 2);
  __decorateClass([
    n4()
  ], LitInputTel.prototype, "description", 2);
  __decorateClass([
    n4()
  ], LitInputTel.prototype, "value", 2);
  __decorateClass([
    n4({ attribute: "max-length" })
  ], LitInputTel.prototype, "maxLength", 2);
  __decorateClass([
    n4()
  ], LitInputTel.prototype, "placeholder", 2);
  LitInputTel = __decorateClass([
    t3("p-input-tel")
  ], LitInputTel);
})();
