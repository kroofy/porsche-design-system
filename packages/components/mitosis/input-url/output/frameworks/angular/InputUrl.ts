/* mitosis-native-host: native angular from InputUrl.lite.tsx */
  ...
  template: `
    ...
    <div class="root">
      ...
      <div class="wrapper">
        ...
        <input type="url" id="input-url" dir="auto"  [value]="inputValue" [placeholder]="placeholderText" [disabled]="isDisabled" [readOnly]="isReadOnly" [maxLength]="maxLengthValue" />
        <slot name="end"></slot>
...
export default class LitInputUrl {
  @Input() disabled!: LitInputUrlProps["disabled"];
  @Input() loading!: LitInputUrlProps["loading"];
  @Input() compact!: LitInputUrlProps["compact"];
  @Input() readOnly!: LitInputUrlProps["readOnly"];
  @Input() indicator!: LitInputUrlProps["indicator"];
  @Input() state!: LitInputUrlProps["state"];
  @Input() message!: LitInputUrlProps["message"];
  @Input() hideLabel!: LitInputUrlProps["hideLabel"];
  @Input() label!: LitInputUrlProps["label"];
  @Input() description!: LitInputUrlProps["description"];
  @Input() value!: LitInputUrlProps["value"];
  @Input() maxLength!: LitInputUrlProps["maxLength"];
  @Input() placeholder!: LitInputUrlProps["placeholder"];
...
@NgModule({
  declarations: [LitInputUrl],
  imports: [CommonModule],
  exports: [LitInputUrl],
})
export class LitInputUrlModule {}
