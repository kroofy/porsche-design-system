...
\f\r"'\`<>=]|("|')|))|$)`, "g");
  ...
  var LitDrilldownLink = class extends i4 {
    ...
    get hasHrefFlag() {
      ...
      return href !== A && href !== void 0 && href !== null;
    }
    get isActiveFlag() {
    ...
    render() {
      const href = this.hrefValue;
      const hasHref = href !== A && href !== void 0 && href !== null;
      ...
      const downloadAttr = download !== A && download !== void 0 && download !== null && download !== "undefined" ? download : A;
