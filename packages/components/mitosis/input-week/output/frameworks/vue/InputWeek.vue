<!-- mitosis-native-host: native vue from InputWeek.lite.tsx -->
<template>
  ...
  <div class="root">
    ...
    <div class="wrapper">
      ...
      ><input type="week" id="input-week" dir="auto"  :value="inputValue" :placeholder="placeholderText" :disabled="isDisabled" :readonly="isReadOnly" :name="name" /><PButtonPure
        class="button"
        type="button"
        icon="calendar"
        hide-label="true"
      >
        Open date picker </PButtonPure
