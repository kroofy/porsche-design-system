...
\f\r"'\`<>=]|("|')|))|$)`, "g");
  ...
  var MASKS = {
    ...
    success: `url('data:image/svg+xml;charset=UTF-8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M12 3a9 9 0 1 0 0 18 9 9 0 0 0 0-18m-1.26 12.69-3.8-3.8 1.07-1.05 2.73 2.73 5.25-5.26 1.06 1.06z"/></svg>') center/contain no-repeat`,
    ...
    error: `url('data:image/svg+xml;charset=UTF-8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M18 3H6a2 2 0 0 0-2 2v12c0 1.1.9 2 2 2h4l2 2 2-2h4a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2m-5 3.5-.4 5.5h-1.2L11 6.5zm-2 7h2v2h-2z"/></svg>') center/contain no-repeat`
  };
  var BGS = {
  ...
  var LitInlineNotification = class extends i4 {
    ...
    render() {
      return b2`<div class="notification" role=${this.roleName} aria-live=${this.ariaLive} aria-label=${this.headingAria || A}>${this.headingNode}${this.descriptionNode}${this.actionNode}${this.dismissNode}</div>`;
    }
  };
