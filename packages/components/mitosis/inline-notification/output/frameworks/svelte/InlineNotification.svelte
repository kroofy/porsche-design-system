...
<script lang="ts">
  ...
  export let dismissButton: LitInlineNotificationProps["dismissButton"];
  export let headingTag: LitInlineNotificationProps["headingTag"];
