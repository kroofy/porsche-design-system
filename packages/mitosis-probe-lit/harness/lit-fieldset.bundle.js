...
\f\r"'\`<>=]|("|')|))|$)`, "g");
  ...
  var LitFieldset = class extends i4 {
    ...
    render() {
      return b2`<fieldset><style .innerHTML="${this.cssText}"></style><legend>${this.labelText}</legend><slot></slot><span class="message" id="message"><p-icon name=${this.iconName || A} color=${this.iconColor || A} aria-hidden="true"></p-icon>${this.messageText}</span></fieldset>`;
    }
  };
...
`;
  ...
  __decorateClass([
    n4()
  ], LitFieldset.prototype, "required", 2);
  __decorateClass([
    n4()
