...
<script lang="ts">
  ...
  export let href: LitLinkPureProps["href"];
  export let icon: LitLinkPureProps["icon"];
  export let iconSource: LitLinkPureProps["iconSource"];
  export let size: LitLinkPureProps["size"];
