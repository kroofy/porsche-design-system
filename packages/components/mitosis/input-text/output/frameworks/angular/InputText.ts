...
export default class LitInputText {
  ...
  @Input() loading!: LitInputTextProps["loading"];
  @Input() compact!: LitInputTextProps["compact"];
  @Input() readOnly!: LitInputTextProps["readOnly"];
  @Input() counter!: LitInputTextProps["counter"];
  @Input() state!: LitInputTextProps["state"];
  @Input() message!: LitInputTextProps["message"];
  @Input() hideLabel!: LitInputTextProps["hideLabel"];
  @Input() label!: LitInputTextProps["label"];
  @Input() description!: LitInputTextProps["description"];
  ...
  get hasCounter() {
    return (
      this.counter === true || this.counter === "true" || this.counter === ""
    );
  }
  get counterText() {
  ...
  get remainingText() {
    ...
    if (this.maxLengthNumber) {
      return `You have ${
        this.maxLengthNumber - this.inputValue.length
      } out of ${this.maxLengthNumber} characters left`;
    }
...
@NgModule({
  declarations: [LitInputText],
  imports: [CommonModule],
  exports: [LitInputText],
})
export class LitInputTextModule {}
