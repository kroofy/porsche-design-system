...
\f\r"'\`<>=]|("|')|))|$)`, "g");
  ...
  // ../../components/mitosis/input-month/output/lit/InputMonth.ts
...
`;
  ...
  __decorateClass([
    n4()
  ], LitInputMonth.prototype, "name", 2);
  __decorateClass([
    n4()
