...
export default class LitTextarea {
  ...
  @Input() compact!: LitTextareaProps["compact"];
  @Input() readOnly!: LitTextareaProps["readOnly"];
  @Input() counter!: LitTextareaProps["counter"];
  @Input() resize!: LitTextareaProps["resize"];
  @Input() state!: LitTextareaProps["state"];
  @Input() message!: LitTextareaProps["message"];
  @Input() hideLabel!: LitTextareaProps["hideLabel"];
  @Input() label!: LitTextareaProps["label"];
  @Input() description!: LitTextareaProps["description"];
  @Input() value!: LitTextareaProps["value"];
...
@NgModule({
  declarations: [LitTextarea],
  imports: [CommonModule],
  exports: [LitTextarea],
})
export class LitTextareaModule {}
