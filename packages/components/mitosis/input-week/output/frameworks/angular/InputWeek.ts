/* mitosis-native-host: native angular from InputWeek.lite.tsx */
...
export interface LitInputWeekProps {
  label?: string;
  description?: string;
  message?: string;
  state?: string;
...
@Component({
  selector: "lit-input-week",
  template: `
    <div class="p-input-week" data-pds="input-week">
    <div class="root">
      <style [innerHTML]="sanitizer.bypassSecurityTrustHtml(scopedCssText)"></style>
      <div class="label-wrapper">
        <label class="label" id="label" for="input-week">{{labelText}}</label>
        <slot name="label-after"></slot>
      </div>
      <span class="label" id="description">{{descriptionText}}</span>
      <div class="wrapper">
        <slot name="start"></slot>
        <input type="week" id="input-week" dir="auto"  [value]="inputValue" [placeholder]="placeholderText" [disabled]="isDisabled" [readOnly]="isReadOnly" />
        <p-button-pure
          class="button"
          type="button"
          icon="calendar"
...
export default class LitInputWeek {
  @Input() disabled!: LitInputWeekProps["disabled"];
  @Input() loading!: LitInputWeekProps["loading"];
  @Input() compact!: LitInputWeekProps["compact"];
  @Input() readOnly!: LitInputWeekProps["readOnly"];
  @Input() state!: LitInputWeekProps["state"];
  @Input() message!: LitInputWeekProps["message"];
  @Input() hideLabel!: LitInputWeekProps["hideLabel"];
  @Input() label!: LitInputWeekProps["label"];
  @Input() description!: LitInputWeekProps["description"];
  @Input() value!: LitInputWeekProps["value"];
  @Input() placeholder!: LitInputWeekProps["placeholder"];

  get scopedCssText() {
    return scopeCss(this.cssText, ".p-input-week");
  }
...
@NgModule({
  declarations: [LitInputWeek],
  imports: [CommonModule],
  exports: [LitInputWeek],
})
export class LitInputWeekModule {}
