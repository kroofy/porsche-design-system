...
export default class LitDrilldown {
  ...
  get cssText() {
    ...
    const activeId =
      this.activeIdentifier == null || this.activeIdentifier === ""
        ? ""
        : String(this.activeIdentifier);
...
@NgModule({
  declarations: [LitDrilldown],
  imports: [CommonModule],
  exports: [LitDrilldown],
})
export class LitDrilldownModule {}
