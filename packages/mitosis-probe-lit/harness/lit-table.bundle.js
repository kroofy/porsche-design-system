...
\f\r"'\`<>=]|("|')|))|$)`, "g");
  ...
  var LitTable = class extends i4 {
    ...
    connectedCallback() {
      ...
      this.shadowRoot?.addEventListener("internalSortingChange", (e5) => {
        e5.stopPropagation();
        this.dispatchEvent(
          new CustomEvent("update", { bubbles: false, detail: e5.detail })
        );
      });
    }
    disconnectedCallback() {
...
`;
  __decorateClass([
    n4()
  ], LitTable.prototype, "sticky", 2);
  __decorateClass([
    n4()
  ], LitTable.prototype, "compact", 2);
  __decorateClass([
    n4()
  ], LitTable.prototype, "layout", 2);
  __decorateClass([
    n4()
  ], LitTable.prototype, "caption", 2);
  LitTable = __decorateClass([
    t3("lit-table")
  ], LitTable);
})();
