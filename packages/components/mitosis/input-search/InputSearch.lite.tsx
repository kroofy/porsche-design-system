...
useMetadata({ tagName: 'p-input-search' });
...
export default function LitInputSearch(props: {
  label?: string;
  description?: string;
  message?: string;
  state?: string;
  ...
  const state = useStore({
    get hostStyle(): Record<string, string> {
      ...
      const hasClear = isTrue(props.clear);
  ...
  return (
    <div class="root">
      <div class="label-wrapper">
        <label class="label" id="label" for="input-search">
          {state.labelText}
        </label>
        <slot name="label-after" />
      </div>
      ...
      <div class="wrapper">
        ...
        <p-button-pure class="button" type="button" icon="close" hide-label="true">
          Clear field
        </p-button-pure>
        <slot name="end" />
