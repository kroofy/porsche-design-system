...
\f\r"'\`<>=]|("|')|))|$)`, "g");
  ...
  var LitPinCode = class extends i4 {
    ...
    get spinnerNode() {
      ...
      return b2`<p-spinner class="spinner" size="inherit" aria-hidden="true"></p-spinner>`;
    }
    get messageNode() {
      const text = this.messageText;
      const icon = this.iconName;
      if (!text) return b2`<span id="message" class="message" role="alert"></span>`;
