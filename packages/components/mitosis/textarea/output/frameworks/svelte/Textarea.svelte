...
<script lang="ts">
  ...
  export let counter: LitTextareaProps["counter"];
  export let resize: LitTextareaProps["resize"];
  export let state: LitTextareaProps["state"];
  export let message: LitTextareaProps["message"];
  export let hideLabel: LitTextareaProps["hideLabel"];
  export let label: LitTextareaProps["label"];
  export let description: LitTextareaProps["description"];
  export let value: LitTextareaProps["value"];
