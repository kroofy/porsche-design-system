...
\f\r"'\`<>=]|("|')|))|$)`, "g");
  ...
  // ../../components/mitosis/multi-select-option/output/lit/MultiSelectOption.ts
  var LitMultiSelectOption = class extends i4 {
    ...
    get isHighlighted() {
      return this.highlighted === true || this.highlighted === "true" || this.highlighted === "";
    }
    get optionClass() {
    ...
    syncHostAria() {
      ...
      const hasValue = rawValue !== void 0 && rawValue !== null;
