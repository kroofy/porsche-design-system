...
useMetadata({ tagName: 'p-input-url' });
...
export default function LitInputUrl(props: {
  label?: string;
  description?: string;
  message?: string;
  state?: string;
  ...
  return (
    <div class="root">
      <div class="label-wrapper">
        <label class="label" id="label" for="input-url">
          {state.labelText}
        </label>
        <slot name="label-after" />
      </div>
      ...
      <div class="wrapper">
        <slot name="start" />
        <p-icon name="linked" color="contrast-low" aria-hidden="true" />
