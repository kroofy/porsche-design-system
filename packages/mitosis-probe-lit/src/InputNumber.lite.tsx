...
useMetadata({ tagName: 'lit-input-number' });

export default function LitInputNumber(props: {
  label?: string;
  description?: string;
  message?: string;
  state?: string;
  ...
  return (
    <div class="root">
      ...
      <div class="label-wrapper">
        <label class="label" id="label" for="input-number">
          {state.labelText}
        </label>
      ...
      <div class="wrapper">
        ...
        <p-button-pure class="button" type="button" icon="minus" hide-label="true">
          Decrement value by 1
        </p-button-pure>
        <p-button-pure class="button" type="button" icon="plus" hide-label="true">
