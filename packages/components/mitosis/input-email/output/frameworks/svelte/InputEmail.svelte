<!-- mitosis-native-host: native svelte from InputEmail.lite.tsx -->
...
<script lang="ts">
  ...
  export let disabled: LitInputEmailProps["disabled"];
  export let loading: LitInputEmailProps["loading"];
  export let compact: LitInputEmailProps["compact"];
  export let readOnly: LitInputEmailProps["readOnly"];
  export let indicator: LitInputEmailProps["indicator"];
  export let state: LitInputEmailProps["state"];
  export let message: LitInputEmailProps["message"];
  export let hideLabel: LitInputEmailProps["hideLabel"];
  export let label: LitInputEmailProps["label"];
  export let description: LitInputEmailProps["description"];
  export let value: LitInputEmailProps["value"];
  export let maxLength: LitInputEmailProps["maxLength"];
  export let placeholder: LitInputEmailProps["placeholder"];
  ...
  $: scopedCssText = scopeCss("\n  :host([hidden]) {\n    display: none !important;\n  }\n" + (typeof cssText === "function" ? cssText() : (cssText || "")), ".p-input-email");
</script>
...
<div class="root">
  ...
  <div class="label-wrapper">
    <label class="label" id="label" for="input-email">{labelText()}</label><slot
      name="label-after"
    />
  </div>
  ...
  <div class="wrapper">
    <slot name="start" /><PIcon
      ...
      color="contrast-low"
      aria-hidden="true"
    /><input type="email" id="input-email" dir="auto"  value={inputValue()} placeholder={placeholderText()} disabled={!!isDisabled()} readonly={!!isReadOnly()} maxlength={maxLengthValue()} /><slot
      name="end"
