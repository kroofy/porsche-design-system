...
export default class LitSegmentedControl {
  ...
  @Input() compact!: LitSegmentedControlProps["compact"];
  @Input() noWrap!: LitSegmentedControlProps["noWrap"];
  @Input() state!: LitSegmentedControlProps["state"];
  @Input() message!: LitSegmentedControlProps["message"];
  @Input() hideLabel!: LitSegmentedControlProps["hideLabel"];
  @Input() columns!: LitSegmentedControlProps["columns"];
...
@NgModule({
  declarations: [LitSegmentedControl],
  imports: [CommonModule],
  exports: [LitSegmentedControl],
})
export class LitSegmentedControlModule {}
