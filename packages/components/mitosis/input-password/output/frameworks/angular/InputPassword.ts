...
export default class LitInputPassword {
  ...
  @Input() loading!: LitInputPasswordProps["loading"];
  @Input() compact!: LitInputPasswordProps["compact"];
  @Input() readOnly!: LitInputPasswordProps["readOnly"];
  @Input() toggle!: LitInputPasswordProps["toggle"];
  @Input() state!: LitInputPasswordProps["state"];
  @Input() message!: LitInputPasswordProps["message"];
  @Input() hideLabel!: LitInputPasswordProps["hideLabel"];
  @Input() label!: LitInputPasswordProps["label"];
  @Input() description!: LitInputPasswordProps["description"];
...
@NgModule({
  declarations: [LitInputPassword],
  imports: [CommonModule],
  exports: [LitInputPassword],
})
export class LitInputPasswordModule {}
