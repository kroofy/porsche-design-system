/* mitosis-native-host: native react from Wordmark.lite.tsx */
...
function LitWordmark(props: LitWordmarkProps) {
  function cssText() {
  ...
  return (
    <div
      className={["p-wordmark", props.className].filter(Boolean).join(" ")}
      data-pds="wordmark"
    >
