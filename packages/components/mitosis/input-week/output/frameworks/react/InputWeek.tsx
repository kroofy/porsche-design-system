/* mitosis-native-host: native react from InputWeek.lite.tsx */
...
function LitInputWeek(props: LitInputWeekProps) {
  function cssText() {
    const minWidth: any = {
      xs: 480,
      s: 760,
  ...
  return (
    <div
      className={["p-input-week", props.className].filter(Boolean).join(" ")}
      data-pds="input-week"
    >
      <div className="root">
        <style dangerouslySetInnerHTML={{ __html: scopeCss("\n        :host([hidden]) {\n          display: none !important;\n        }\n      " + cssText(), ".p-input-week") }} />
        <div className="label-wrapper">
          <label className="label" id="label" htmlFor="input-week">
            {labelText()}
          </label>
