...
export default class LitInputNumber {
  ...
  @Input() loading!: LitInputNumberProps["loading"];
  @Input() compact!: LitInputNumberProps["compact"];
  @Input() readOnly!: LitInputNumberProps["readOnly"];
  @Input() controls!: LitInputNumberProps["controls"];
  @Input() state!: LitInputNumberProps["state"];
  @Input() message!: LitInputNumberProps["message"];
  @Input() hideLabel!: LitInputNumberProps["hideLabel"];
  @Input() label!: LitInputNumberProps["label"];
  @Input() description!: LitInputNumberProps["description"];
...
@NgModule({
  declarations: [LitInputNumber],
  imports: [CommonModule],
  exports: [LitInputNumber],
})
export class LitInputNumberModule {}
