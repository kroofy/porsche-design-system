...
\f\r"'\`<>=]|("|')|))|$)`, "g");
  ...
  var LitDrilldownLink = class extends i4 {
    ...
    get hrefValue() {
      if (this.href !== void 0 && this.href !== null) return this.href;
...
`;
  __decorateClass([
    n4()
  ], LitDrilldownLink.prototype, "aria", 2);
  __decorateClass([
    n4()
  ], LitDrilldownLink.prototype, "rel", 2);
  __decorateClass([
    n4()
  ], LitDrilldownLink.prototype, "download", 2);
  __decorateClass([
    n4()
  ], LitDrilldownLink.prototype, "target", 2);
  __decorateClass([
    n4()
  ], LitDrilldownLink.prototype, "href", 2);
  __decorateClass([
    n4()
  ], LitDrilldownLink.prototype, "active", 2);
  LitDrilldownLink = __decorateClass([
    t3("lit-drilldown-link")
  ], LitDrilldownLink);
})();
