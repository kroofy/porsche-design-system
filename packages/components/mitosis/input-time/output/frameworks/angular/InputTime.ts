/* mitosis-native-host: native angular from InputTime.lite.tsx */
...
export default class LitInputTime {
  @Input() disabled!: LitInputTimeProps["disabled"];
  @Input() loading!: LitInputTimeProps["loading"];
  @Input() compact!: LitInputTimeProps["compact"];
  @Input() readOnly!: LitInputTimeProps["readOnly"];
  @Input() state!: LitInputTimeProps["state"];
  @Input() message!: LitInputTimeProps["message"];
  @Input() hideLabel!: LitInputTimeProps["hideLabel"];
  @Input() label!: LitInputTimeProps["label"];
  @Input() description!: LitInputTimeProps["description"];
  @Input() value!: LitInputTimeProps["value"];
  @Input() placeholder!: LitInputTimeProps["placeholder"];
...
@NgModule({
  declarations: [LitInputTime],
  imports: [CommonModule],
  exports: [LitInputTime],
})
export class LitInputTimeModule {}
