...
\f\r"'\`<>=]|("|')|))|$)`, "g");
  ...
  // ../../components/mitosis/button/output/lit/Button.ts
  var LitButton = class extends i4 {
    ...
    render() {
      return b2`
          ...
          <button class="root" .type="${this.buttonType}">
          ...
          <p-icon class="icon"
            ...
            .source="${this.iconSrc}"
          ></p-icon>
          <p-spinner class="spinner" size="inherit" aria-hidden="true"></p-spinner>
          <span class="label"><slot></slot></span>
          <span class="loading" id="loading" role="status">${this.loadingText}</span>
        </button>
