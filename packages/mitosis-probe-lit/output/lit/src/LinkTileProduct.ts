...
@customElement("lit-link-tile-product")
...
`;
  ...
  @property() href: any;
  @property() likeButton: any;
  @property() priceOriginal: any;
  ...
  get cssText() {
    ...
    const hasPriceOriginal = !!(
      (this.priceOriginal ?? this.getAttribute("price-original") ?? this.getAttribute("priceoriginal")) &&
      (this.priceOriginal ?? this.getAttribute("price-original") ?? this.getAttribute("priceoriginal")) !== "undefined"
    );
