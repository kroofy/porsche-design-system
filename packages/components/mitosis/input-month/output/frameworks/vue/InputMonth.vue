<!-- mitosis-native-host: native vue from InputMonth.lite.tsx -->
<template>
  ...
  <div class="root">
    ...
    <div class="wrapper">
      ...
      ><input type="month" id="input-month" dir="auto"  :value="inputValue" :placeholder="placeholderText" :disabled="isDisabled" :readonly="isReadOnly" :name="name" /><PButtonPure
        class="button"
        type="button"
        icon="calendar"
        hide-label="true"
