/* mitosis-native-host: native react from MultiSelect.lite.tsx */
...
function LitMultiSelect(props: LitMultiSelectProps) {
  ...
  return (
    <div
      className={["p-multi-select", props.className].filter(Boolean).join(" ")}
      data-pds="multi-select"
    >
      <div className="root">
        <style dangerouslySetInnerHTML={{ __html: scopeCss("\n        :host([hidden]) {\n          display: none !important;\n        }\n      " + cssText(), ".p-multi-select") }} />
