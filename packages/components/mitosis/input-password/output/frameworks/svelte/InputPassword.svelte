<!-- mitosis-native-host: native svelte from InputPassword.lite.tsx -->
<script context="module" lang="ts">
  export interface LitInputPasswordProps {
    label?: string;
    description?: string;
    message?: string;
    state?: string;
...
<script lang="ts">
  ...
  export let disabled: LitInputPasswordProps["disabled"];
  export let loading: LitInputPasswordProps["loading"];
  export let compact: LitInputPasswordProps["compact"];
  export let readOnly: LitInputPasswordProps["readOnly"];
  export let toggle: LitInputPasswordProps["toggle"];
  export let state: LitInputPasswordProps["state"];
  export let message: LitInputPasswordProps["message"];
  export let hideLabel: LitInputPasswordProps["hideLabel"];
  export let label: LitInputPasswordProps["label"];
  export let description: LitInputPasswordProps["description"];
  export let value: LitInputPasswordProps["value"];
  export let maxLength: LitInputPasswordProps["maxLength"];
  export let placeholder: LitInputPasswordProps["placeholder"];
  function __cmpProps() { return { disabled, loading, compact, readOnly, toggle, state, message, hideLabel, label, description, value, maxLength, placeholder }; }
  ...
  $: scopedCssText = scopeCss("\n  :host([hidden]) {\n    display: none !important;\n  }\n" + (typeof cssText === "function" ? cssText() : (cssText || "")), ".p-input-password");
</script>
...
<div class="root">
  ...
  <div class="label-wrapper">
    <label class="label" id="label" for="input-password">{labelText()}</label
