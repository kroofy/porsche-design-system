...
@customElement("p-input-number")
export default class LitInputNumber extends LitElement {
  static styles = css`
      :host([hidden]) {
...
`;
  ...
  @property({ attribute: "read-only" }) readOnly: any;
  ...
  @property() value: any;
  @property({ attribute: "max-length" }) maxLength: any;
