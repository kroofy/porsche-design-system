...
\f\r"'\`<>=]|("|')|))|$)`, "g");
  ...
  var LitSwitch = class extends i4 {
    ...
    get ariaChecked() {
      const checked = this.checked === true || this.checked === "true" || this.checked === "";
    ...
    render() {
      return b2`<div class="wrap"><style .innerHTML="${this.cssText}"></style><button type="button" role="switch" id="x" aria-checked=${this.ariaChecked} aria-disabled=${this.ariaDisabled || A} aria-labelledby="label"><span class="toggle"><p-spinner class="spinner" aria-hidden="true"></p-spinner></span></button><label id="label" for="x"><slot></slot></label><span class="loading" id="loading" role="status">${this.loadingText}</span></div>`;
    }
  };
  LitSwitch.styles = i`
      :host([hidden]) {
...
`;
  __decorateClass([
    n4()
  ], LitSwitch.prototype, "checked", 2);
  __decorateClass([
    n4()
  ], LitSwitch.prototype, "disabled", 2);
  __decorateClass([
    n4()
  ], LitSwitch.prototype, "loading", 2);
  __decorateClass([
    n4()
  ], LitSwitch.prototype, "compact", 2);
  __decorateClass([
    n4()
  ], LitSwitch.prototype, "alignLabel", 2);
  __decorateClass([
    n4()
  ], LitSwitch.prototype, "hideLabel", 2);
  __decorateClass([
    n4()
  ], LitSwitch.prototype, "stretch", 2);
  LitSwitch = __decorateClass([
    t3("lit-switch")
  ], LitSwitch);
})();
