...
export default class LitModelSignature {
  ...
  @Input() size!: LitModelSignatureProps["size"];
  @Input() color!: LitModelSignatureProps["color"];
...
@NgModule({
  declarations: [LitModelSignature],
  imports: [CommonModule],
  exports: [LitModelSignature],
})
export class LitModelSignatureModule {}
