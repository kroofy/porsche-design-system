...
export default class LitLinkTileProduct {
  ...
  @Input() likeButton!: LitLinkTileProductProps["likeButton"];
  @Input() priceOriginal!: LitLinkTileProductProps["priceOriginal"];
  @Input() description!: LitLinkTileProductProps["description"];
...
@NgModule({
  declarations: [LitLinkTileProduct],
  imports: [CommonModule],
  exports: [LitLinkTileProduct],
})
export class LitLinkTileProductModule {}
