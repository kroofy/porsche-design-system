...
@customElement("lit-model-signature")
export default class LitModelSignature extends LitElement {
  static styles = css`
      :host {
...
`;
  ...
  @property() size: any;
  @property() color: any;
  @property() safeZone: any;
  @property() fetchPriority: any;
  @property() lazy: any;
  ...
  get cssText() {
    ...
    let safeZone: any = this.safeZone;
