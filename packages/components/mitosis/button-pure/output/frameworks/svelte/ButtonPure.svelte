...
<script lang="ts">
  ...
  export let underline: LitButtonPureProps["underline"];
  export let active: LitButtonPureProps["active"];
  export let icon: LitButtonPureProps["icon"];
  export let iconSource: LitButtonPureProps["iconSource"];
  export let size: LitButtonPureProps["size"];
  export let stretch: LitButtonPureProps["stretch"];
