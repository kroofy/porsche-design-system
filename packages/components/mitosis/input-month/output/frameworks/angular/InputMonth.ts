...
export default class LitInputMonth {
  ...
  @Input() loading!: LitInputMonthProps["loading"];
  @Input() compact!: LitInputMonthProps["compact"];
  @Input() readOnly!: LitInputMonthProps["readOnly"];
  @Input() state!: LitInputMonthProps["state"];
  @Input() message!: LitInputMonthProps["message"];
  @Input() hideLabel!: LitInputMonthProps["hideLabel"];
  @Input() label!: LitInputMonthProps["label"];
...
@NgModule({
  declarations: [LitInputMonth],
  imports: [CommonModule],
  exports: [LitInputMonth],
})
export class LitInputMonthModule {}
