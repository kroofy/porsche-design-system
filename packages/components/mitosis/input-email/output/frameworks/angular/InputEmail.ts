...
export default class LitInputEmail {
  ...
  @Input() loading!: LitInputEmailProps["loading"];
  @Input() compact!: LitInputEmailProps["compact"];
  @Input() readOnly!: LitInputEmailProps["readOnly"];
  @Input() indicator!: LitInputEmailProps["indicator"];
  @Input() state!: LitInputEmailProps["state"];
  @Input() message!: LitInputEmailProps["message"];
  @Input() hideLabel!: LitInputEmailProps["hideLabel"];
  @Input() label!: LitInputEmailProps["label"];
  @Input() description!: LitInputEmailProps["description"];
...
@NgModule({
  declarations: [LitInputEmail],
  imports: [CommonModule],
  exports: [LitInputEmail],
})
export class LitInputEmailModule {}
