<!-- mitosis-native-host: native svelte from InputWeek.lite.tsx -->
...
<script lang="ts">
  ...
  export let disabled: LitInputWeekProps["disabled"];
  export let loading: LitInputWeekProps["loading"];
  export let compact: LitInputWeekProps["compact"];
  export let readOnly: LitInputWeekProps["readOnly"];
  export let state: LitInputWeekProps["state"];
  export let message: LitInputWeekProps["message"];
  export let hideLabel: LitInputWeekProps["hideLabel"];
  export let label: LitInputWeekProps["label"];
  export let description: LitInputWeekProps["description"];
  export let value: LitInputWeekProps["value"];
  export let placeholder: LitInputWeekProps["placeholder"];
  ...
  $: scopedCssText = scopeCss("\n  :host([hidden]) {\n    display: none !important;\n  }\n" + (typeof cssText === "function" ? cssText() : (cssText || "")), ".p-input-week");
</script>
...
<div class="root">
  ...
  <div class="label-wrapper">
    <label class="label" id="label" for="input-week">{labelText()}</label><slot
      name="label-after"
    />
  </div>
