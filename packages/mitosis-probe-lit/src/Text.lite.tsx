...
export default function LitText(props: {
  ...
  const state = useStore({
    get cssText(): string {
      ...
      let extra = '';
      if (hyphens === 'auto' || hyphens === 'manual') extra += ';overflow-wrap:break-word';
      if (ellipsis) extra += ';max-width:100%;overflow:hidden;text-overflow:ellipsis;white-space:nowrap';
      const rootOpen =
