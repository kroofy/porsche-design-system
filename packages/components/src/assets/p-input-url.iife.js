...
\f\r"'\`<>=]|("|')|))|$)`, "g");
  ...
  // ../../components/mitosis/input-url/output/lit/InputUrl.ts
  var LitInputUrl = class extends i4 {
    get cssText() {
      const minWidth = {
        xs: 480,
        s: 760,
    ...
    get indicatorIconSrc() {
      return "http://localhost:3001/icons/linked.8f30cb5.svg";
    }
    updated() {
...
`;
  __decorateClass([
    n4()
  ], LitInputUrl.prototype, "disabled", 2);
  __decorateClass([
    n4()
  ], LitInputUrl.prototype, "loading", 2);
  __decorateClass([
    n4()
  ], LitInputUrl.prototype, "compact", 2);
  __decorateClass([
    n4({ attribute: "read-only" })
  ], LitInputUrl.prototype, "readOnly", 2);
  __decorateClass([
    n4()
  ], LitInputUrl.prototype, "indicator", 2);
  __decorateClass([
    n4()
  ], LitInputUrl.prototype, "state", 2);
  __decorateClass([
    n4()
  ], LitInputUrl.prototype, "message", 2);
  __decorateClass([
    n4({ attribute: "hide-label" })
  ], LitInputUrl.prototype, "hideLabel", 2);
  __decorateClass([
    n4()
  ], LitInputUrl.prototype, "label", 2);
  __decorateClass([
    n4()
  ], LitInputUrl.prototype, "name", 2);
  __decorateClass([
    n4()
  ], LitInputUrl.prototype, "description", 2);
  __decorateClass([
    n4()
  ], LitInputUrl.prototype, "value", 2);
  __decorateClass([
    n4({ attribute: "max-length" })
  ], LitInputUrl.prototype, "maxLength", 2);
  __decorateClass([
    n4()
  ], LitInputUrl.prototype, "placeholder", 2);
  LitInputUrl = __decorateClass([
    t3("p-input-url")
  ], LitInputUrl);
})();
