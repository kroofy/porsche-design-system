...
\f\r"'\`<>=]|("|')|))|$)`, "g");
  ...
  // output/lit/src/SegmentedControlItem.ts
  var LitSegmentedControlItem = class extends i4 {
    ...
    get isDisabled() {
      ...
      return disabled === true || disabled === "true" || disabled === "" || parent === true || parent === "true" || parent === "";
    }
    get isSelected() {
    ...
    render() {
      ...
      const labelNode = label ? b2`<span>${label}</span>` : A;
      const iconNode = hasIcon ? b2`<p-icon class="icon" name=${icon || A} source=${source || A} color="inherit" size="inherit" aria-hidden="true"></p-icon>` : A;
      return b2`<button type="button" aria-pressed=${selected ? "true" : "false"} aria-disabled=${disabled ? "true" : A}><style .innerHTML="${this.cssText}"></style>${labelNode}${iconNode}<slot></slot></button>`;
    }
  };
...
`;
  __decorateClass([
    n4()
  ], LitSegmentedControlItem.prototype, "message", 2);
  __decorateClass([
    n4()
  ], LitSegmentedControlItem.prototype, "value", 2);
  __decorateClass([
    n4()
  ], LitSegmentedControlItem.prototype, "compact", 2);
  __decorateClass([
    n4()
  ], LitSegmentedControlItem.prototype, "disabled", 2);
  __decorateClass([
    n4()
  ], LitSegmentedControlItem.prototype, "disabledParent", 2);
  __decorateClass([
    n4()
  ], LitSegmentedControlItem.prototype, "selected", 2);
  __decorateClass([
    n4()
  ], LitSegmentedControlItem.prototype, "state", 2);
  __decorateClass([
    n4()
  ], LitSegmentedControlItem.prototype, "icon", 2);
  __decorateClass([
    n4()
  ], LitSegmentedControlItem.prototype, "iconSource", 2);
  __decorateClass([
    n4()
  ], LitSegmentedControlItem.prototype, "label", 2);
  LitSegmentedControlItem = __decorateClass([
    t3("lit-segmented-control-item")
  ], LitSegmentedControlItem);
})();
