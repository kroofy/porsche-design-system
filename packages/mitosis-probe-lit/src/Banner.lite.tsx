...
useMetadata({ tagName: 'lit-banner' });
...
export default function LitBanner(props: {
  ...
  const state = useStore({
    get cssText(): string {
      ...
      const posRule = (v: any) => {
        if (v === 'top') return '--_p-banner-a:' + topA + ';inset-block:' + topInset;
      ...
      let out =
        ...
        (typeof position === 'object' && position !== null ? posRule(position.base || 'bottom') : posRule(position)) +
