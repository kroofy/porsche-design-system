...
<script lang="ts">
  ...
  export let state: LitRadioGroupProps["state"];
  export let message: LitRadioGroupProps["message"];
  export let hideLabel: LitRadioGroupProps["hideLabel"];
  export let direction: LitRadioGroupProps["direction"];
