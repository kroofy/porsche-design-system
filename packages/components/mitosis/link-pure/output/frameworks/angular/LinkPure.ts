...
export default class LitLinkPure {
  ...
  @Input() underline!: LitLinkPureProps["underline"];
  @Input() active!: LitLinkPureProps["active"];
  @Input() href!: LitLinkPureProps["href"];
  @Input() icon!: LitLinkPureProps["icon"];
  @Input() iconSource!: LitLinkPureProps["iconSource"];
  @Input() size!: LitLinkPureProps["size"];
...
@NgModule({
  declarations: [LitLinkPure],
  imports: [CommonModule],
  exports: [LitLinkPure],
})
export class LitLinkPureModule {}
