...
\f\r"'\`<>=]|("|')|))|$)`, "g");
  ...
  var assignHide = (vars, bp, hidden) => {
    const p3 = bp === "base" ? "--p-ta-lw" : `--p-ta-lw-${bp}`;
    const d3 = bp === "base" ? "--p-ta-desc" : `--p-ta-desc-${bp}`;
    if (hidden) {
  ...
  var LitTextarea = class extends i4 {
    get hostStyle() {
      ...
      const resize = this.getAttribute("resize") ?? this.resize ?? "vertical";
      ...
      :host {
        ...
        @media (min-width: 760px) {
          .label-wrapper {
            min-width: var(
              --p-ta-lw-s-minw,
              var(--p-ta-lw-xs-minw, var(--p-ta-lw-minw))
            );
            position: var(
              --p-ta-lw-s-pos,
              var(--p-ta-lw-xs-pos, var(--p-ta-lw-pos, static))
            );
            ...
            overflow: var(
              --p-ta-lw-s-ov,
              var(--p-ta-lw-xs-ov, var(--p-ta-lw-ov, visible))
            );
            clip: var(
              --p-ta-lw-s-clip,
              var(--p-ta-lw-xs-clip, var(--p-ta-lw-clip, auto))
            );
            white-space: var(
              --p-ta-lw-s-ws,
              var(--p-ta-lw-xs-ws, var(--p-ta-lw-ws, normal))
            );
          }
          .label:is(span) {
            position: var(
              --p-ta-desc-s-pos,
              var(--p-ta-desc-xs-pos, var(--p-ta-desc-pos, static))
            );
            width: var(
              --p-ta-desc-s-w,
              var(--p-ta-desc-xs-w, var(--p-ta-desc-w, auto))
            );
            height: var(
              --p-ta-desc-s-h,
              var(--p-ta-desc-xs-h, var(--p-ta-desc-h, auto))
            );
            padding: var(
              --p-ta-desc-s-pad,
              var(--p-ta-desc-xs-pad, var(--p-ta-desc-pad, 0))
            );
            margin: var(--p-ta-desc-s-m, var(--p-ta-desc-xs-m, var(--p-ta-desc-m, 0)));
            overflow: var(
              --p-ta-desc-s-ov,
              var(--p-ta-desc-xs-ov, var(--p-ta-desc-ov, visible))
            );
            clip: var(
              --p-ta-desc-s-clip,
              var(--p-ta-desc-xs-clip, var(--p-ta-desc-clip, auto))
            );
            white-space: var(
              --p-ta-desc-s-ws,
              var(--p-ta-desc-xs-ws, var(--p-ta-desc-ws, normal))
            );
            margin-top: calc(-1 * var(--p-spacing-static-xs));
          }
        }
