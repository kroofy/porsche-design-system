...
export default class LitButtonTile {
  ...
  @Input() weight!: LitButtonTileProps["weight"];
  @Input() aspectRatio!: LitButtonTileProps["aspectRatio"];
  @Input() compact!: LitButtonTileProps["compact"];
  @Input() align!: LitButtonTileProps["align"];
  @Input() disabled!: LitButtonTileProps["disabled"];
  @Input() loading!: LitButtonTileProps["loading"];
...
@NgModule({
  declarations: [LitButtonTile],
  imports: [CommonModule],
  exports: [LitButtonTile],
})
export class LitButtonTileModule {}
