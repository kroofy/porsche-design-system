...
\f\r"'\`<>=]|("|')|))|$)`, "g");
  ...
  var LitAccordion = class extends i4 {
    ...
    get isOpenFlag() {
      return (this.open ?? this.getAttribute("open")) === true || (this.open ?? this.getAttribute("open")) === "true" || (this.open ?? this.getAttribute("open")) === "";
    }
    firstUpdated() {
    ...
    render() {
      ...
      const heading = tag === "h1" ? b2`<h1>${this.headingText}<slot name="heading"></slot></h1>` : tag === "h3" ? b2`<h3>${this.headingText}<slot name="heading"></slot></h3>` : tag === "h4" ? b2`<h4>${this.headingText}<slot name="heading"></slot></h4>` : tag === "h5" ? b2`<h5>${this.headingText}<slot name="heading"></slot></h5>` : tag === "h6" ? b2`<h6>${this.headingText}<slot name="heading"></slot></h6>` : b2`<h2>${this.headingText}<slot name="heading"></slot></h2>`;
      return b2`<details ?open=${open}><style .innerHTML="${this.cssText}"></style><summary><slot name="summary"></slot>${heading}</summary><slot name="summary-before"></slot><slot name="summary-after"></slot><div><slot></slot></div></details>`;
    }
  };
