...
useMetadata({ tagName: 'lit-input-week' });

export default function LitInputWeek(props: {
  label?: string;
  description?: string;
  message?: string;
  state?: string;
  ...
  return (
    <div class="root">
      ...
      <div class="label-wrapper">
        <label class="label" id="label" for="input-week">
          {state.labelText}
        </label>
      ...
      <div class="wrapper">
        ...
        <p-button-pure class="button" type="button" icon="calendar" hide-label="true">
          Open date picker
        </p-button-pure>
        <slot name="end" />
