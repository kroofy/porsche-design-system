...
useMetadata({ tagName: 'lit-pagination' });
  ...
  const state = useStore({
    get cssText(): string {
      ...
      if (pageTotal < 8) {
        ...
        if (pageTotal - active < 4) minS += 'li.ellip-end:nth-last-child(3){display:none}';
        if (pageTotal - active < 3) minS += 'li.ellip-end:nth-last-child(2){display:none}';
      }
