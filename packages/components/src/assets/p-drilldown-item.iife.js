      ...
      @keyframes slide-up-mobile {
        ...
        @media (min-width: 760px) {
          :host([primary]) slot:not([name]) {
            ...
            height: fit-content;
            padding-block-end: var(--p-spacing-fluid-lg);
            animation: slide-up-desktop-primary
          ...
          :host([secondary]) slot:not([name]) {
            ...
            height: fit-content;
            padding-block-end: var(--p-spacing-fluid-lg);
            animation: slide-up-desktop-secondary
              var(--p-animation-duration, var(--p-duration-md)) var(--p-ease-in-out);
          }
          :host([cascade]) slot:not([name]) {
            display: contents;
          ...
          :host([secondary]) .drawer {
            ...
            display: grid;
            grid-template:
              var(--p-spacing-fluid-md) minmax(0, 1fr) / var(--p-spacing-fluid-lg)
              minmax(0, 1fr) var(--p-spacing-fluid-lg);
          }
          :host([primary]) .drawer,
          :host([cascade]) .drawer {
            display: contents;
