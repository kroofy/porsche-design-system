...
\f\r"'\`<>=]|("|')|))|$)`, "g");
  ...
  var LitInputMonth = class extends i4 {
    ...
    get maxLengthValue() {
      return this.maxLength == null || this.maxLength === "" ? "" : String(this.maxLength);
    }
    get isDisabled() {
  ...
  LitInputMonth.styles = i`
      :host {
        ...
        .button {
          padding: var(--ref-p-input-slotted-padding);
          margin: var(--ref-p-input-slotted-margin);
        }
        .loading {
          position: absolute;
          width: 1px;
...
`;
  ...
  __decorateClass([
    n4()
  ], LitInputMonth.prototype, "maxLength", 2);
  __decorateClass([
    n4()
