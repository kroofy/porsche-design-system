...
\f\r"'\`<>=]|("|')|))|$)`, "g");
  ...
  // ../../components/mitosis/tabs-item/output/lit/TabsItem.ts
  var LitTabsItem = class extends i4 {
    get cssText() {
      return ":host{display:block;color:var(--p-color-primary) !important;border-radius:2px !important}:host([hidden]){display:none !important}:host(:focus-visible){outline:2px solid var(--p-color-focus) !important;outline-offset:2px !important}@media(forced-colors:active){:host(:focus-visible){outline-color:Highlight !important}}";
    }
    get labelValue() {
      return this.label || "";
    }
...
`;
  __decorateClass([
    n4()
  ], LitTabsItem.prototype, "label", 2);
  LitTabsItem = __decorateClass([
    t3("p-tabs-item")
  ], LitTabsItem);
})();
