...
export default class LitRadioGroup {
  ...
  @Input() loading!: LitRadioGroupProps["loading"];
  @Input() compact!: LitRadioGroupProps["compact"];
  @Input() state!: LitRadioGroupProps["state"];
  @Input() message!: LitRadioGroupProps["message"];
  @Input() hideLabel!: LitRadioGroupProps["hideLabel"];
  @Input() direction!: LitRadioGroupProps["direction"];
...
@NgModule({
  declarations: [LitRadioGroup],
  imports: [CommonModule],
  exports: [LitRadioGroup],
})
export class LitRadioGroupModule {}
