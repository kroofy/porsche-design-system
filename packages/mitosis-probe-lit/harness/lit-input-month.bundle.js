...
\f\r"'\`<>=]|("|')|))|$)`, "g");
  ...
  // output/lit/src/InputMonth.ts
  var LitInputMonth = class extends i4 {
    get cssText() {
      const minWidth = {
        xs: 480,
        s: 760,
    ...
    render() {
      return b2`<div class="root"><style .innerHTML="${this.cssText}"></style><div class="label-wrapper"><label class="label" id="label" for="input-month">${this.labelText}</label><slot name="label-after"></slot></div><span class="label" id="description">${this.descriptionText}</span><div class="wrapper"><slot name="start"></slot><input type="month" id="input-month" dir="auto" .value=${this.inputValue} placeholder=${this.placeholderText || A} name=${this.name || A} ?disabled=${!!this.isDisabled} ?readonly=${!!this.isReadOnly} aria-disabled=${this.ariaDisabled || A} aria-invalid=${this.ariaInvalid || A} aria-readonly=${this.ariaReadonly || A}><p-button-pure class="button" type="button" icon="calendar" hide-label="true" ?disabled=${!!this.isDisabled || !!this.isReadOnly}>Open date picker</p-button-pure><slot name="end"></slot><p-spinner aria-hidden="true"></p-spinner></div><span class="message" id="message"><p-icon name=${this.iconName || A} color=${this.iconColor || A} aria-hidden="true"></p-icon>${this.messageText}</span><span class="loading" id="loading" role="status">${this.loadingText}</span></div>`;
    }
  };
  LitInputMonth.styles = i`
      :host([hidden]) {
...
`;
  __decorateClass([
    n4()
  ], LitInputMonth.prototype, "disabled", 2);
  __decorateClass([
    n4()
  ], LitInputMonth.prototype, "loading", 2);
  __decorateClass([
    n4()
  ], LitInputMonth.prototype, "compact", 2);
  __decorateClass([
    n4()
  ], LitInputMonth.prototype, "readOnly", 2);
  __decorateClass([
    n4()
  ], LitInputMonth.prototype, "state", 2);
  __decorateClass([
    n4()
  ], LitInputMonth.prototype, "message", 2);
  __decorateClass([
    n4()
  ], LitInputMonth.prototype, "hideLabel", 2);
  __decorateClass([
    n4()
  ], LitInputMonth.prototype, "label", 2);
  __decorateClass([
    n4()
  ], LitInputMonth.prototype, "description", 2);
  __decorateClass([
    n4()
  ], LitInputMonth.prototype, "value", 2);
  __decorateClass([
    n4()
  ], LitInputMonth.prototype, "placeholder", 2);
  LitInputMonth = __decorateClass([
    t3("lit-input-month")
  ], LitInputMonth);
})();
