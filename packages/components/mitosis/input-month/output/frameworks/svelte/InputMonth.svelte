<!-- mitosis-native-host: native svelte from InputMonth.lite.tsx -->
<script context="module" lang="ts">
  export interface LitInputMonthProps {
    label?: string;
    description?: string;
    message?: string;
    state?: string;
...
<script lang="ts">
  ...
  export let disabled: LitInputMonthProps["disabled"];
  export let loading: LitInputMonthProps["loading"];
  export let compact: LitInputMonthProps["compact"];
  export let readOnly: LitInputMonthProps["readOnly"];
  export let state: LitInputMonthProps["state"];
  export let message: LitInputMonthProps["message"];
  export let hideLabel: LitInputMonthProps["hideLabel"];
  export let label: LitInputMonthProps["label"];
  export let description: LitInputMonthProps["description"];
  export let value: LitInputMonthProps["value"];
  export let placeholder: LitInputMonthProps["placeholder"];
  ...
  $: scopedCssText = scopeCss("\n  :host([hidden]) {\n    display: none !important;\n  }\n" + (typeof cssText === "function" ? cssText() : (cssText || "")), ".p-input-month");
</script>
...
<div class="root">
  ...
  <div class="label-wrapper">
    <label class="label" id="label" for="input-month">{labelText()}</label><slot
      name="label-after"
    />
  </div>
