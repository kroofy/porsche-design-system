...
\f\r"'\`<>=]|("|')|))|$)`, "g");
  ...
  // ../../components/mitosis/input-password/output/lit/InputPassword.ts
  var LitInputPassword = class extends i4 {
    get cssText() {
      const minWidth = {
        xs: 480,
        s: 760,
      ...
      const hasToggle = isTrue(this.getAttribute("toggle") ?? this.toggle);
    ...
    get toggleIconSrc() {
      return "http://localhost:3001/icons/view.5b4d7f6.svg";
    }
    updated() {
...
`;
  __decorateClass([
    n4()
  ], LitInputPassword.prototype, "disabled", 2);
  __decorateClass([
    n4()
  ], LitInputPassword.prototype, "loading", 2);
  __decorateClass([
    n4()
  ], LitInputPassword.prototype, "compact", 2);
  __decorateClass([
    n4({ attribute: "read-only" })
  ], LitInputPassword.prototype, "readOnly", 2);
  __decorateClass([
    n4()
  ], LitInputPassword.prototype, "toggle", 2);
  __decorateClass([
    n4()
  ], LitInputPassword.prototype, "state", 2);
  __decorateClass([
    n4()
  ], LitInputPassword.prototype, "message", 2);
  __decorateClass([
    n4({ attribute: "hide-label" })
  ], LitInputPassword.prototype, "hideLabel", 2);
  __decorateClass([
    n4()
  ], LitInputPassword.prototype, "label", 2);
  __decorateClass([
    n4()
  ], LitInputPassword.prototype, "name", 2);
  __decorateClass([
    n4()
  ], LitInputPassword.prototype, "description", 2);
  __decorateClass([
    n4()
  ], LitInputPassword.prototype, "value", 2);
  __decorateClass([
    n4({ attribute: "max-length" })
  ], LitInputPassword.prototype, "maxLength", 2);
  __decorateClass([
    n4()
  ], LitInputPassword.prototype, "placeholder", 2);
  LitInputPassword = __decorateClass([
    t3("p-input-password")
  ], LitInputPassword);
})();
