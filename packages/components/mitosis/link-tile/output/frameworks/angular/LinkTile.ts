...
export default class LitLinkTile {
  ...
  @Input() weight!: LitLinkTileProps["weight"];
  @Input() aspectRatio!: LitLinkTileProps["aspectRatio"];
  @Input() compact!: LitLinkTileProps["compact"];
  @Input() align!: LitLinkTileProps["align"];
...
@NgModule({
  declarations: [LitLinkTile],
  imports: [CommonModule],
  exports: [LitLinkTile],
})
export class LitLinkTileModule {}
