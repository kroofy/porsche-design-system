...
useMetadata({ tagName: 'lit-link-tile-product' });
...
export default function LitLinkTileProduct(props: {
  ...
  const state = useStore({
    get cssText(): string {
      ...
      const hasPriceOriginal = !!(props.priceOriginal && props.priceOriginal !== 'undefined');
      const hasDescription = !!(props.description && props.description !== 'undefined');
