...
export default class LitInlineNotification {
  ...
  @Input() heading!: LitInlineNotificationProps["heading"];
  @Input() actionLabel!: LitInlineNotificationProps["actionLabel"];
  @Input() dismissButton!: LitInlineNotificationProps["dismissButton"];
  @Input() headingTag!: LitInlineNotificationProps["headingTag"];
...
@NgModule({
  declarations: [LitInlineNotification],
  imports: [CommonModule],
  exports: [LitInlineNotification],
})
export class LitInlineNotificationModule {}
