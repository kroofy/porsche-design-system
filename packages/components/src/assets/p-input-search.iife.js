...
\f\r"'\`<>=]|("|')|))|$)`, "g");
  ...
  // ../../components/mitosis/input-search/output/lit/InputSearch.ts
  var LitInputSearch = class extends i4 {
    get cssText() {
      const minWidth = {
        xs: 480,
        s: 760,
    ...
    render() {
      return b2`<div class="root"><style .innerHTML="${this.cssText}"></style><div class="label-wrapper"><label class="label" id="label" for="input-search">${this.labelText}</label><slot name="label-after"></slot></div><span class="label" id="description">${this.descriptionText}</span><div class="wrapper"><slot name="start"></slot><p-icon name="search" source=${this.indicatorIconSrc || A} color="contrast-medium" aria-hidden="true"></p-icon><input type="search" id="input-search" dir="auto" .value=${this.inputValue} placeholder=${this.placeholderText || A} name=${this.name || A} ?disabled=${!!this.isDisabled} ?readonly=${!!this.isReadOnly} maxlength=${this.maxLengthValue || A} aria-disabled=${this.ariaDisabled || A} aria-invalid=${this.ariaInvalid || A} aria-readonly=${this.ariaReadonly || A}><p-button-pure class="button" type="button" icon="close" icon-source=${this.clearIconSrc || A} hide-label="true" tabindex="-1" ?disabled=${!!this.isDisabled || !!this.isReadOnly} ?hidden=${!this.isClearable}>Clear field</p-button-pure><slot name="end"></slot><p-spinner aria-hidden="true"></p-spinner></div><span class="message" id="message"><p-icon name=${this.iconName || A} source=${this.iconSrc || A} color=${this.iconColor || A} aria-hidden="true"></p-icon>${this.messageText}</span><span class="loading" id="loading" role="status">${this.loadingText}</span></div>`;
    }
  };
  LitInputSearch.styles = i`
      :host([hidden]) {
...
`;
  __decorateClass([
    n4()
  ], LitInputSearch.prototype, "disabled", 2);
  __decorateClass([
    n4()
  ], LitInputSearch.prototype, "loading", 2);
  __decorateClass([
    n4()
  ], LitInputSearch.prototype, "compact", 2);
  __decorateClass([
    n4({ attribute: "read-only" })
  ], LitInputSearch.prototype, "readOnly", 2);
  __decorateClass([
    n4()
  ], LitInputSearch.prototype, "indicator", 2);
  __decorateClass([
    n4()
  ], LitInputSearch.prototype, "clear", 2);
  __decorateClass([
    n4()
  ], LitInputSearch.prototype, "state", 2);
  __decorateClass([
    n4()
  ], LitInputSearch.prototype, "message", 2);
  __decorateClass([
    n4({ attribute: "hide-label" })
  ], LitInputSearch.prototype, "hideLabel", 2);
  __decorateClass([
    n4()
  ], LitInputSearch.prototype, "label", 2);
  __decorateClass([
    n4()
  ], LitInputSearch.prototype, "name", 2);
  __decorateClass([
    n4()
  ], LitInputSearch.prototype, "description", 2);
  __decorateClass([
    n4()
  ], LitInputSearch.prototype, "value", 2);
  __decorateClass([
    n4({ attribute: "max-length" })
  ], LitInputSearch.prototype, "maxLength", 2);
  __decorateClass([
    n4()
  ], LitInputSearch.prototype, "placeholder", 2);
  LitInputSearch = __decorateClass([
    t3("p-input-search")
  ], LitInputSearch);
})();
