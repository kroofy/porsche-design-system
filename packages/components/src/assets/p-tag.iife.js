  ...
  var LitTag = class extends i4 {
    get hostStyle() {
      ...
      return {
        ...
        "--p-tag-pad": compact ? "var(--p-spacing-static-2xs) var(--p-spacing-static-sm)" : "4px calc(12 * var(--p-spacing-static-2xs))",
        "--p-tag-radius": compact ? "calc(1px + (var(--p-leading-normal) / 2))" : "calc(4px + (var(--p-leading-normal) / 2))",
