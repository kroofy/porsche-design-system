...
export default class LitFlyout {
  ...
  @Input() background!: LitFlyoutProps["background"];
  @Input() backdrop!: LitFlyoutProps["backdrop"];
  @Input() position!: LitFlyoutProps["position"];
  ...
  get cssText() {
    ...
    let fullscreen: any = this.fullscreen;
...
@NgModule({
  declarations: [LitFlyout],
  imports: [CommonModule],
  exports: [LitFlyout],
})
export class LitFlyoutModule {}
