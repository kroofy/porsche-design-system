...
useMetadata({ tagName: 'lit-accordion' });
...
export default function LitAccordion(props: {
  ...
  const state = useStore({
    get cssText(): string {
      ...
      const isSticky = isTrue(props.sticky);
      ...
      if (hasSummary) out += 'summary > h1,summary > h2,summary > h3,summary > h4,summary > h5,summary > h6{display:none}';
