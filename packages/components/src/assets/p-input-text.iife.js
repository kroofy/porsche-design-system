...
\f\r"'\`<>=]|("|')|))|$)`, "g");
  ...
  // ../../components/mitosis/input-text/output/lit/InputText.ts
  var LitInputText = class extends i4 {
    get cssText() {
      const minWidth = {
        xs: 480,
        s: 760,
    ...
    get maxLengthNumber() {
      const parsed = Number.parseInt(this.maxLengthValue, 10);
      return Number.isFinite(parsed) ? parsed : 0;
    }
    get hasCounter() {
      return (this.counter ?? this.getAttribute("counter")) === true || (this.counter ?? this.getAttribute("counter")) === "true" || (this.counter ?? this.getAttribute("counter")) === "";
    }
    get counterText() {
      if (!this.hasCounter) return "";
      if (this.maxLengthNumber)
        return `${this.inputValue.length}/${this.maxLengthNumber}`;
      return `${this.inputValue.length}`;
    }
    get remainingText() {
      if (!this.hasCounter) return "";
      if (this.maxLengthNumber) {
        return `You have ${this.maxLengthNumber - this.inputValue.length} out of ${this.maxLengthNumber} characters left`;
      }
      return `${this.inputValue.length} characters entered`;
    }
    get isDisabled() {
...
`;
  __decorateClass([
    n4()
  ], LitInputText.prototype, "disabled", 2);
  __decorateClass([
    n4()
  ], LitInputText.prototype, "loading", 2);
  __decorateClass([
    n4()
  ], LitInputText.prototype, "compact", 2);
  __decorateClass([
    n4({ attribute: "read-only" })
  ], LitInputText.prototype, "readOnly", 2);
  __decorateClass([
    n4()
  ], LitInputText.prototype, "counter", 2);
  __decorateClass([
    n4()
  ], LitInputText.prototype, "state", 2);
  __decorateClass([
    n4()
  ], LitInputText.prototype, "message", 2);
  __decorateClass([
    n4({ attribute: "hide-label" })
  ], LitInputText.prototype, "hideLabel", 2);
  __decorateClass([
    n4()
  ], LitInputText.prototype, "label", 2);
  __decorateClass([
    n4()
  ], LitInputText.prototype, "name", 2);
  __decorateClass([
    n4()
  ], LitInputText.prototype, "description", 2);
  __decorateClass([
    n4()
  ], LitInputText.prototype, "value", 2);
  __decorateClass([
    n4({ attribute: "max-length" })
  ], LitInputText.prototype, "maxLength", 2);
  __decorateClass([
    n4()
  ], LitInputText.prototype, "placeholder", 2);
  LitInputText = __decorateClass([
    t3("p-input-text")
  ], LitInputText);
})();
