...
export default class LitButtonPure {
  ...
  @Input() loading!: LitButtonPureProps["loading"];
  @Input() color!: LitButtonPureProps["color"];
  @Input() underline!: LitButtonPureProps["underline"];
  @Input() active!: LitButtonPureProps["active"];
  @Input() icon!: LitButtonPureProps["icon"];
  @Input() iconSource!: LitButtonPureProps["iconSource"];
  @Input() size!: LitButtonPureProps["size"];
  @Input() stretch!: LitButtonPureProps["stretch"];
...
@NgModule({
  declarations: [LitButtonPure],
  imports: [CommonModule],
  exports: [LitButtonPure],
})
export class LitButtonPureModule {}
