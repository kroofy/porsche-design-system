...
\f\r"'\`<>=]|("|')|))|$)`, "g");
  ...
  // output/lit/src/LinkTileProduct.ts
...
`;
  LitLinkTileProduct.shadowRootOptions = { ...i4.shadowRootOptions, delegatesFocus: true };
  __decorateClass([
    n4()
  ], LitLinkTileProduct.prototype, "rel", 2);
  __decorateClass([
    n4()
  ...
  __decorateClass([
    n4()
  ], LitLinkTileProduct.prototype, "heading", 2);
  __decorateClass([
    n4()
  ], LitLinkTileProduct.prototype, "price", 2);
  LitLinkTileProduct = __decorateClass([
    t3("lit-link-tile-product")
  ], LitLinkTileProduct);
})();
