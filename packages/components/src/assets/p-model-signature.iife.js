...
\f\r"'\`<>=]|("|')|))|$)`, "g");
  ...
  // ../../components/mitosis/model-signature/output/lit/ModelSignature.ts
  var LitModelSignature = class extends i4 {
    get cssText() {
      const manifest = {
        "718": {
          src: "718.493a9e3.svg",
      ...
      return ":host{width:var(--p-model-signature-width," + widthFallback + ");height:var(--p-model-signature-height,auto);mask:url(" + src + ") no-repeat left top / contain !important;aspect-ratio:" + entry.width + " / " + aspectH + " !important;background:var(--p-model-signature-color," + bg + ") !important}::slotted(:is(img,video)){display:block !important;width:100% !important;height:100% !important;object-fit:cover !important}img{position:absolute;opacity:0;width:1px;height:1px}@media(forced-colors:active){:host{background:CanvasText !important}}";
    }
    get src() {
      const files = {
        "718": "718.493a9e3.svg",
      ...
      const model = this.model || "911";
      return "http://localhost:3001/model-signatures/" + (files[model] || files["911"]);
    }
    get alt() {
      return this.model || "911";
    }
    get fetchPriorityAttr() {
      const fp = this.fetchPriority || "auto";
      return fp !== "auto" ? fp : void 0;
    }
    get loadingAttr() {
    ...
    render() {
      return b2`
          ...
          <img
            .src="${this.src}"
            .alt="${this.alt}"
            .fetchpriority="${this.fetchPriorityAttr}"
            .loading="${this.loadingAttr}"
        />

        `;
    }
  };
  LitModelSignature.styles = i`
      :host {
...
`;
  __decorateClass([
    n4()
  ], LitModelSignature.prototype, "model", 2);
  __decorateClass([
    n4()
  ], LitModelSignature.prototype, "size", 2);
  __decorateClass([
    n4()
  ], LitModelSignature.prototype, "color", 2);
  __decorateClass([
    n4()
  ], LitModelSignature.prototype, "safeZone", 2);
  __decorateClass([
    n4()
  ], LitModelSignature.prototype, "fetchPriority", 2);
  __decorateClass([
    n4()
  ], LitModelSignature.prototype, "lazy", 2);
  LitModelSignature = __decorateClass([
    t3("p-model-signature")
  ], LitModelSignature);
})();
