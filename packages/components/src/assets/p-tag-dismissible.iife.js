...
\f\r"'\`<>=]|("|')|))|$)`, "g");
  ...
  // ../../components/mitosis/tag-dismissible/output/lit/TagDismissible.ts
  var LitTagDismissible = class extends i4 {
    get hostStyle() {
      const compact = this.compact === true || this.compact === "true" || this.compact === "";
      ...
      return {
        ...
        "--p-tag-dismissible-pad-block": hasLabel ? "calc(16.8px * (var(--_p-tag-dismissible-a) - 0.64285714))" : "calc(28px * (var(--_p-tag-dismissible-a) - 0.64285714) + 6px)",
  ...
  LitTagDismissible.styles = i`
      :host {
        ...
        button {
          ...
          padding: var(--p-tag-dismissible-pad-block)
