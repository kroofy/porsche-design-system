...
\f\r"'\`<>=]|("|')|))|$)`, "g");
  ...
  var LitLinkTile = class extends i4 {
    get cssText() {
      ...
      out += "@media(hover:hover){.root:hover slot:not([name]){transform:scale3d(1.05,1.05,1.05)}}@supports (-webkit-hyphens: auto){.root{height:100%}}";
    ...
    render() {
      ...
      const downloadAttr = download && download !== "undefined" ? download : A;
...
`;
  LitLinkTile.shadowRootOptions = { ...i4.shadowRootOptions, delegatesFocus: true };
  __decorateClass([
    n4()
