...
\f\r"'\`<>=]|("|')|))|$)`, "g");
  ...
  // ../../components/mitosis/select/output/lit/Select.ts
  var LitSelect = class extends i4 {
    get cssText() {
      const minWidth = {
        xs: 480,
        s: 760,
      ...
      let out = "@keyframes fade-in{from{opacity:0}to{opacity:1}}:host{display:block;--_p-select-a:" + scale + " !important;--_p-select-option-a:" + scale + " !important;--_p-optgroup-a:" + scale + ' !important}:host([hidden]){display:none !important}slot[name="label-after"]{display:inline-block;vertical-align:top}slot[name="label-after"]::slotted(*){margin-inline-start:var(--p-spacing-static-xs) !important}.label-after{display:inline-block;vertical-align:top}:not(:defined,[data-ssr]){visibility:hidden}button{all:unset;display:flex;align-items:center;gap:calc(22.4px * (var(--_p-select-a) - 0.64285714) + 4px);height:calc(var(--_p-select-a) * 3.5rem);box-sizing:border-box;min-width:0;padding-inline:calc(22.4px * (var(--_p-select-a) - 0.64285714) + 8px);border:1px solid var(--p-select-border-color,' + palette.border + ");border-radius:" + (compact ? "var(--p-radius-lg)" : "var(--p-radius-xl)") + ";background:var(--p-select-background-color," + palette.bg + ");font:var(--p-font-weight-normal) var(--p-typescale-sm) / var(--p-leading-normal) var(--p-font-porsche-next);color:var(--p-select-text-color,var(--p-color-primary));cursor:" + (disabled ? "not-allowed" : "pointer");
      ...
      if (!disabled) {
        out += "button:focus-visible{outline:2px solid var(--p-color-focus);outline-offset:2px}@media(forced-colors:active){button:focus-visible{outline-color:Highlight}}@media(hover:hover){button:hover,label:hover~button{border-color:var(--p-select-border-color," + palette.hover + ")}}";
      }
      if (disabled) {
        out += "@media(forced-colors:active){button{opacity:1;color:GrayText}}";
      }
      out += 'button img{font:var(--p-typescale-sm) var(--p-font-porsche-next);width:auto;height:var(--p-leading-normal);border-radius:var(--p-radius-sm)}button span{flex-grow:1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}[popover]{all:unset;position:absolute;z-index:99;padding:calc(11.2px * (var(--_p-select-a) - 0.64285714) + 4px);display:none;flex-direction:column;gap:calc(11.2px * (var(--_p-select-a) - 0.64285714) + 4px);max-height:max(calc(224px), calc(50vh - 54px / 2 - 6px * 2));box-sizing:border-box;overflow:hidden auto;scrollbar-width:thin;scrollbar-color:auto;animation:var(--p-animation-duration,var(--p-duration-sm)) fade-in var(--p-ease-in-out) forwards;filter:drop-shadow(0 0 8px rgba(0,0,0,0.15));background:var(--p-color-canvas);border:1px solid var(--p-color-contrast-low);border-radius:var(--p-radius-xl)}[popover]:not(:popover-open){display:none}slot[name="selected"]{display:block;height:100%;flex-grow:1;overflow:hidden}.root{display:grid;gap:var(--p-spacing-static-xs);min-width:calc(1rem + var(--p-spacing-static-md) + 1px * 2 + calc(9px + var(--p-spacing-static-md) / 2 + (var(--p-leading-normal) + var(--p-spacing-static-xs) * 2) * 1))}.options{display:flex;flex-direction:column;gap:calc(11.2px * (var(--_p-select-a) - 0.64285714) + 4px)}.icon{margin-inline-end:-3px;pointer-events:none;transform:rotate3d(0,0,1,0.0001deg);transition:transform var(--p-transition-duration,var(--p-duration-sm)) var(--p-ease-in-out)}.sr-only{position:absolute;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;clip:rect(0,0,0,0);white-space:nowrap}';
...
`;
  ...
  ], LitSelect.prototype, "dropdownDirection", 2);
  __decorateClass([
    n4()
  ], LitSelect.prototype, "form", 2);
  __decorateClass([
    n4()
  ], LitSelect.prototype, "name", 2);
  __decorateClass([
    n4()
  ], LitSelect.prototype, "value", 2);
  __decorateClass([
    n4()
  ], LitSelect.prototype, "filter", 2);
  __decorateClass([
    n4()
  ], LitSelect.prototype, "disabled", 2);
  __decorateClass([
    n4()
  ], LitSelect.prototype, "compact", 2);
  __decorateClass([
    n4()
  ], LitSelect.prototype, "state", 2);
  __decorateClass([
    n4()
  ], LitSelect.prototype, "message", 2);
  __decorateClass([
    n4({ attribute: "hide-label" })
  ], LitSelect.prototype, "hideLabel", 2);
  __decorateClass([
    n4()
  ], LitSelect.prototype, "label", 2);
  __decorateClass([
    n4()
  ], LitSelect.prototype, "description", 2);
  __decorateClass([
    n4()
  ], LitSelect.prototype, "required", 2);
  LitSelect = __decorateClass([
    t3("p-select")
  ], LitSelect);
})();
