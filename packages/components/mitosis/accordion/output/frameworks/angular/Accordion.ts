...
export default class LitAccordion {
  ...
  @Input() compact!: LitAccordionProps["compact"];
  @Input() sticky!: LitAccordionProps["sticky"];
  @Input() alignMarker!: LitAccordionProps["alignMarker"];
  @Input() background!: LitAccordionProps["background"];
  @Input() indent!: LitAccordionProps["indent"];
...
@NgModule({
  declarations: [LitAccordion],
  imports: [CommonModule],
  exports: [LitAccordion],
})
export class LitAccordionModule {}
