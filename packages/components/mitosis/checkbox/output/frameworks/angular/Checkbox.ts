...
export default class LitCheckbox {
  ...
  @Input() loading!: LitCheckboxProps["loading"];
  @Input() compact!: LitCheckboxProps["compact"];
  @Input() state!: LitCheckboxProps["state"];
  @Input() message!: LitCheckboxProps["message"];
...
@NgModule({
  declarations: [LitCheckbox],
  imports: [CommonModule],
  exports: [LitCheckbox],
})
export class LitCheckboxModule {}
