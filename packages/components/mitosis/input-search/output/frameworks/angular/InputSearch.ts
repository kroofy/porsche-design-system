...
export default class LitInputSearch {
  ...
  @Input() loading!: LitInputSearchProps["loading"];
  @Input() compact!: LitInputSearchProps["compact"];
  @Input() readOnly!: LitInputSearchProps["readOnly"];
  @Input() indicator!: LitInputSearchProps["indicator"];
  @Input() clear!: LitInputSearchProps["clear"];
  @Input() state!: LitInputSearchProps["state"];
  @Input() message!: LitInputSearchProps["message"];
  @Input() hideLabel!: LitInputSearchProps["hideLabel"];
  @Input() label!: LitInputSearchProps["label"];
  @Input() description!: LitInputSearchProps["description"];
...
@NgModule({
  declarations: [LitInputSearch],
  imports: [CommonModule],
  exports: [LitInputSearch],
})
export class LitInputSearchModule {}
