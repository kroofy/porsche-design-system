...
\f\r"'\`<>=]|("|')|))|$)`, "g");
  ...
  // output/lit/src/Tabs.ts
  var LitTabs = class extends i4 {
    constructor() {
      super(...arguments);
      this.onBarUpdate = (e5) => {
        e5.stopPropagation();
        const next = e5.detail?.activeTabIndex;
    ...
    get activeIndex() {
      ...
      const n5 = Number(raw);
      return Number.isInteger(n5) ? n5 : 0;
    }
    tabItems() {
    ...
    parsedAria() {
      ...
      return extra && typeof extra === "object" ? extra : A;
    }
    syncPanels() {
...
`;
  __decorateClass([
    n4()
  ], LitTabs.prototype, "aria", 2);
  __decorateClass([
    n4()
  ], LitTabs.prototype, "weight", 2);
  __decorateClass([
    n4()
  ], LitTabs.prototype, "size", 2);
  __decorateClass([
    n4()
  ], LitTabs.prototype, "background", 2);
  __decorateClass([
    n4()
  ], LitTabs.prototype, "compact", 2);
  __decorateClass([
    n4()
  ], LitTabs.prototype, "activeTabIndex", 2);
  LitTabs = __decorateClass([
    t3("lit-tabs")
  ], LitTabs);
})();
