...
useMetadata({ tagName: 'lit-input-time' });

export default function LitInputTime(props: {
  label?: string;
  description?: string;
  message?: string;
  state?: string;
  ...
  return (
    <div class="root">
      ...
      <div class="label-wrapper">
        <label class="label" id="label" for="input-time">
          {state.labelText}
        </label>
      ...
      <div class="wrapper">
        ...
        <p-button-pure class="button" type="button" icon="clock" hide-label="true">
          Open time picker
        </p-button-pure>
        <slot name="end" />
