...
\f\r"'\`<>=]|("|')|))|$)`, "g");
  ...
  var assignBp = (vars, bp, hide, compact) => {
    const s4 = bp === "base" ? "" : `-${bp}`;
    const hidden = isTrue(hide);
    const compactOn = isTrue(compact);
    vars[`--p-lnk-scale${s4}`] = compactOn ? "0.64285714" : "1";
    vars[`--p-lnk-br${s4}`] = compactOn ? "var(--p-radius-lg)" : "var(--p-radius-xl)";
    vars[`--p-lnk-host-r${s4}`] = hidden ? "var(--p-link-radius, var(--p-radius-full))" : "var(--p-link-radius, var(--_p-link-button-a))";
    vars[`--p-lnk-slot-r${s4}`] = hidden ? "var(--p-link-radius, var(--p-radius-full))" : compactOn ? "var(--p-link-radius, var(--p-radius-lg))" : "var(--p-link-radius, var(--p-radius-xl))";
    vars[`--p-lnk-pad${s4}`] = hidden ? "var(--p-link-py, calc(28px * (var(--_p-link-a) - 0.64285714) + 6px)) var(--p-link-px, calc(28px * (var(--_p-link-a) - 0.64285714) + 6px))" : "var(--p-link-py, calc(28px * (var(--_p-link-a) - 0.64285714) + 6px)) var(--p-link-px, calc(33.6px * (var(--_p-link-a) - 0.64285714) + 16px))";
    vars[`--p-lnk-gap${s4}`] = hidden ? "var(--p-link-gap, 0)" : "var(--p-link-gap, calc(11.2px * (var(--_p-link-a) - 0.64285714) + 4px))";
    vars[`--p-lnk-icon-m${s4}`] = hidden ? "0" : "calc(-1 * (11.2px * (var(--_p-link-a) - 0.64285714) + 4px))";
    if (hidden) {
      vars[`--p-lnk-l-pos${s4}`] = "absolute";
      vars[`--p-lnk-l-w${s4}`] = "1px";
      vars[`--p-lnk-l-h${s4}`] = "1px";
      vars[`--p-lnk-l-pad${s4}`] = "0";
      vars[`--p-lnk-l-m${s4}`] = "-1px";
      vars[`--p-lnk-l-ov${s4}`] = "hidden";
      vars[`--p-lnk-l-clip${s4}`] = bp === "base" ? "unset" : "rect(0, 0, 0, 0)";
      vars[`--p-lnk-l-ws${s4}`] = "nowrap";
      return;
    }
    vars[`--p-lnk-l-pos${s4}`] = "static";
    vars[`--p-lnk-l-w${s4}`] = "auto";
    vars[`--p-lnk-l-h${s4}`] = "auto";
    vars[`--p-lnk-l-pad${s4}`] = "0";
    vars[`--p-lnk-l-m${s4}`] = "0";
    vars[`--p-lnk-l-ov${s4}`] = "visible";
    vars[`--p-lnk-l-clip${s4}`] = bp === "base" ? "unset" : "auto";
    vars[`--p-lnk-l-ws${s4}`] = "normal";
  };
  var LitLink = class extends i4 {
    get hostStyle() {
      ...
      const vars = {
        "--p-lnk-bg": secondary ? "var(--p-link-bg, var(--p-color-frosted-strong))" : "var(--p-link-bg, var(--p-color-primary))",
        "--p-lnk-fg": secondary ? "var(--p-link-fg, var(--p-color-primary))" : "var(--p-link-fg, var(--p-color-canvas))",
        "--p-lnk-hbg": secondary ? "var(--p-link-bg, var(--p-color-frosted))" : "var(--p-link-bg, var(--p-color-contrast-high))"
      };
      if (typeof hideLabel === "object" || typeof compact === "object") {
        ...
        for (const bp of BREAKPOINTS) {
          if (hideObj && hideObj[bp] !== void 0)
            lastH = pick(hideObj, bp, lastH);
    ...
    render() {
      return b2`
          ...
          <span class="root"><p-icon class="icon"
            size="inherit"
            color="inherit"
            aria-hidden="true"
            .name="${this.iconName}"
