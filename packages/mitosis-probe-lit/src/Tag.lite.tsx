...
useMetadata({ tagName: 'lit-tag' });

export default function LitTag(props: {
  variant?: string;
  icon?: string;
  iconSource?: string;
  compact?: any;
  ...
  return (
    <span>
      ...
      <p-icon class="icon" name={state.iconName} source={state.iconSrc} color="inherit" size="x-small" aria-hidden="true" />
      <slot></slot>
    </span>
  );
}
