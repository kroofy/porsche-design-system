<!-- mitosis-native-host: native vue from InputEmail.lite.tsx -->
<template>
  ...
  <div class="root">
    ...
    <div class="wrapper">
      ...
      ><PIcon name="email" color="contrast-low" aria-hidden="true"></PIcon
      ><input type="email" id="input-email" dir="auto"  :value="inputValue" :placeholder="placeholderText" :disabled="isDisabled" :readonly="isReadOnly" :name="name" :maxlength="maxLengthValue" /><slot name="end"></slot
