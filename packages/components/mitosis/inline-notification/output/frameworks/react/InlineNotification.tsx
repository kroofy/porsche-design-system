...
function LitInlineNotification(props: LitInlineNotificationProps) {
  function cssText() {
  ...
  function actionLabelText() {
    return props.actionLabel || "";
  }

  function actionIconName() {
    return props.actionIcon || "arrow-right";
  }

  function actionLoadingFlag() {
...
export default LitInlineNotification;
