  ...
  var LitStepperHorizontal = class extends i4 {
    ...
    stampIcons() {
      ...
      for (const item of this.stepItems()) {
        const state2 = item.state ?? item.getAttribute("state");
        if (state2 !== "complete" && state2 !== "warning") continue;
...
`;
  __decorateClass([
    n4()
  ], LitStepperHorizontal.prototype, "size", 2);
  LitStepperHorizontal = __decorateClass([
    t3("p-stepper-horizontal")
  ], LitStepperHorizontal);
})();
