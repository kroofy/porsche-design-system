  ...
  var LitInputPassword = class extends i4 {
    get hostStyle() {
      ...
      const vars = {
        ...
        "--p-it-btn-pad": hasToggle ? "var(--ref-p-input-slotted-padding)" : "",
        "--p-it-btn-m": hasToggle ? "var(--ref-p-input-slotted-margin)" : "",
