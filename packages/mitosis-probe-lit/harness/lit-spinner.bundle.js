...
\f\r"'\`<>=]|("|')|))|$)`, "g");
  ...
  // output/lit/src/Spinner.ts
  var LitSpinner = class extends i4 {
    get cssText() {
      const sizeMap = {
      ...
      const keyframes = "@keyframes rotate{0%{transform:rotateZ(0deg)}100%{transform:rotateZ(360deg)}}@keyframes dash{0%{stroke-dashoffset:69;transform:rotateZ(0)}50%,75%{stroke-dashoffset:24;transform:rotateZ(80deg)}100%{stroke-dashoffset:69;transform:rotateZ(360deg)}}";
      const rest = "svg{display:block;fill:none;stroke-width:1.5;animation:rotate var(--p-animation-duration,var(--p-duration-xl)) steps(50) infinite}circle:first-child{stroke:var(--p-spinner-track-color,var(--p-color-contrast-lower))}circle:last-child{stroke:var(--p-spinner-color," + color + ");stroke-dasharray:var(--p-temporary-spinner-stroke-dasharray,69);stroke-linecap:round;animation:dash var(--p-animation-duration,var(--p-duration-xl)) steps(50) infinite}@media(forced-colors:active){circle:last-child{stroke:CanvasText}circle:first-child{stroke:none!important}}@supports (color: oklch(from red l c h)){circle:first-child{stroke:var(--p-spinner-track-color,oklch(from var(--p-spinner-color," + color + ") l c h/.2))}}span,.sr-only{position:absolute;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;clip:rect(0,0,0,0);white-space:nowrap}";
      const rootOpen = keyframes + "div{width:var(--p-spinner-size,var(--p-leading-normal));height:var(--p-spinner-size,var(--p-leading-normal));font-family:var(--p-font-porsche-next);";
      ...
      if (typeof size === "object" && size !== null) {
        let out = rootOpen + "font-size:" + fontFor(size.base || "sm") + "}" + rest;
        for (const bp of Object.keys(size)) {
          if (bp === "base") continue;
          out += "@media(min-width:" + minWidth[bp] + "px){div{font-size:" + fontFor(size[bp]) + "}}";
        }
        return out;
      }
    ...
    render() {
      return b2`<div role="alert" aria-live="assertive" aria-label="${this.ariaLabel}"><style .innerHTML="${this.cssText}"></style><span class="sr-only">&nbsp;</span><svg viewBox="-16 -16 32 32" width="100%" height="100%" focusable="false" aria-hidden="true"><circle r="11"></circle><circle r="11"></circle></svg></div>`;
    }
  };
  LitSpinner.styles = i`
      :host {
...
`;
  __decorateClass([
    n4()
  ], LitSpinner.prototype, "color", 2);
  __decorateClass([
    n4()
  ], LitSpinner.prototype, "size", 2);
  __decorateClass([
    n4()
  ], LitSpinner.prototype, "aria", 2);
  LitSpinner = __decorateClass([
    t3("lit-spinner")
  ], LitSpinner);
})();
