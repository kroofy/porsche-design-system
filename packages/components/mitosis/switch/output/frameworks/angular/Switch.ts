...
export default class LitSwitch {
  ...
  @Input() disabled!: LitSwitchProps["disabled"];
  @Input() loading!: LitSwitchProps["loading"];
  @Input() compact!: LitSwitchProps["compact"];
...
@NgModule({
  declarations: [LitSwitch],
  imports: [CommonModule],
  exports: [LitSwitch],
})
export class LitSwitchModule {}
