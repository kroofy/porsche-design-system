...
<script lang="ts">
  ...
  export let compact: LitButtonTileProps["compact"];
  export let align: LitButtonTileProps["align"];
  export let disabled: LitButtonTileProps["disabled"];
  export let loading: LitButtonTileProps["loading"];
