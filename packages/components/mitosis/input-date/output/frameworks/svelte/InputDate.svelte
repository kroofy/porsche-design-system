...
<script lang="ts">
  ...
  export let readOnly: LitInputDateProps["readOnly"];
  export let state: LitInputDateProps["state"];
  export let message: LitInputDateProps["message"];
  export let hideLabel: LitInputDateProps["hideLabel"];
  export let label: LitInputDateProps["label"];
