...
<script lang="ts">
  ...
  export let readOnly: LitInputSearchProps["readOnly"];
  export let indicator: LitInputSearchProps["indicator"];
  export let clear: LitInputSearchProps["clear"];
  export let state: LitInputSearchProps["state"];
  export let message: LitInputSearchProps["message"];
  export let hideLabel: LitInputSearchProps["hideLabel"];
  export let label: LitInputSearchProps["label"];
  export let description: LitInputSearchProps["description"];
