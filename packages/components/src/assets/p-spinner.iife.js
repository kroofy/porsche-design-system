...
\f\r"'\`<>=]|("|')|))|$)`, "g");
  ...
  var LitSpinner = class extends i4 {
    get hostStyle() {
      const vars = {
        "--p-spinner-fallback": COLOR_MAP[this.color || "primary"] || COLOR_MAP.primary
      };
  ...
  LitSpinner.styles = i`
      :host {
        ...
        svg {
          ...
          fill: none;
          stroke-width: 1.5;
          animation: rotate var(--p-animation-duration, var(--p-duration-xl)) steps(50)
            infinite;
        }
        circle:first-child {
        ...
        circle:last-child {
          stroke: var(
            --p-spinner-color,
            var(--p-spinner-fallback, var(--p-color-primary))
          );
          stroke-dasharray: var(--p-temporary-spinner-stroke-dasharray, 69);
          stroke-linecap: round;
          animation: dash var(--p-animation-duration, var(--p-duration-xl)) steps(50)
            infinite;
        }
        ...
        @media (min-width: 480px) {
          div {
            font-size: var(
              --p-spinner-fs-xs,
              var(--p-spinner-fs, var(--p-typescale-sm))
            );
          }
        }
