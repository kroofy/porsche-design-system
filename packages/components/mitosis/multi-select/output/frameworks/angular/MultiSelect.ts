...
export default class LitMultiSelect {
  ...
  @Input() compact!: LitMultiSelectProps["compact"];
  @Input() state!: LitMultiSelectProps["state"];
  @Input() message!: LitMultiSelectProps["message"];
  @Input() hideLabel!: LitMultiSelectProps["hideLabel"];
...
@NgModule({
  declarations: [LitMultiSelect],
  imports: [CommonModule],
  exports: [LitMultiSelect],
})
export class LitMultiSelectModule {}
