<!-- mitosis-native-host: native vue from InputDate.lite.tsx -->
<template>
  ...
  <div class="root">
    ...
    <div class="wrapper">
      ...
      ><input type="date" id="input-date" dir="auto"  :value="inputValue" :placeholder="placeholderText" :disabled="isDisabled" :readonly="isReadOnly" :name="name" /><PButtonPure
        class="button"
        type="button"
        icon="calendar"
        hide-label="true"
