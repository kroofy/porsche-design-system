<!-- mitosis-native-host: native vue from InputTel.lite.tsx -->
<template>
  ...
  <div class="root">
    ...
    <div class="wrapper">
      ...
      ><PIcon name="phone" color="contrast-low" aria-hidden="true"></PIcon
      ><input type="tel" id="input-tel" dir="auto"  :value="inputValue" :placeholder="placeholderText" :disabled="isDisabled" :readonly="isReadOnly" :name="name" :maxlength="maxLengthValue" /><slot name="end"></slot
