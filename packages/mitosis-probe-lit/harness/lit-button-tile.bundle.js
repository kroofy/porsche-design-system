...
`;
  LitButtonTile.shadowRootOptions = { ...i4.shadowRootOptions, delegatesFocus: true };
  __decorateClass([
    n4()
  ], LitButtonTile.prototype, "aria", 2);
  __decorateClass([
    n4()
  ], LitButtonTile.prototype, "iconSource", 2);
  __decorateClass([
    n4()
  ...
  __decorateClass([
    n4()
  ], LitButtonTile.prototype, "weight", 2);
  __decorateClass([
    n4()
  ], LitButtonTile.prototype, "aspectRatio", 2);
  __decorateClass([
    n4()
  ...
  __decorateClass([
    n4()
  ], LitButtonTile.prototype, "label", 2);
  LitButtonTile = __decorateClass([
    t3("lit-button-tile")
  ], LitButtonTile);
})();
