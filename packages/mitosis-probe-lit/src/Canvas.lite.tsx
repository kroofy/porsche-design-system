...
useMetadata({ tagName: 'lit-canvas' });
  ...
  const state = useStore({
    get cssText(): string {
      ...
      return (
        ...
        mask('rgba(0,0,0,100%) 0%,rgba(0,0,0,1) 12.5%,rgba(0,0,0,1) 25%,rgba(0,0,0,0) 37.5%') +
        '}' +
        '.blur>div:nth-of-type(2){-webkit-backdrop-filter:blur(32px);backdrop-filter:blur(32px);' +
        mask('rgba(0,0,0,0) 12.5%,rgba(0,0,0,1) 25%,rgba(0,0,0,1) 37.5%,rgba(0,0,0,0) 50%') +
        '}' +
        '.blur>div:nth-of-type(3){-webkit-backdrop-filter:blur(16px);backdrop-filter:blur(16px);' +
        mask('rgba(0,0,0,0) 25%,rgba(0,0,0,1) 37.5%,rgba(0,0,0,1) 50%,rgba(0,0,0,0) 62.5%') +
        '}' +
        '.blur>div:nth-of-type(4){-webkit-backdrop-filter:blur(8px);backdrop-filter:blur(8px);' +
        mask('rgba(0,0,0,0) 37.5%,rgba(0,0,0,1) 50%,rgba(0,0,0,1) 62.5%,rgba(0,0,0,0) 75%') +
        '}' +
        '.blur>div:nth-of-type(5){-webkit-backdrop-filter:blur(4px);backdrop-filter:blur(4px);' +
        mask('rgba(0,0,0,0) 50%,rgba(0,0,0,1) 62.5%,rgba(0,0,0,1) 75%,rgba(0,0,0,0) 87.5%') +
        '}' +
        '.blur>div:nth-of-type(6){-webkit-backdrop-filter:blur(2px);backdrop-filter:blur(2px);' +
        mask('rgba(0,0,0,0) 62.5%,rgba(0,0,0,1) 75%,rgba(0,0,0,1) 87.5%,rgba(0,0,0,0) 100%') +
        '}' +
