...
\f\r"'\`<>=]|("|')|))|$)`, "g");
  ...
  // ../../components/mitosis/crest/output/lit/Crest.ts
  var LitCrest = class extends i4 {
    get cssText() {
      return 'a{all:unset;cursor:pointer}a::before{content:"";position:absolute;inset:0;border-radius:1px}a:focus-visible::before{outline:2px solid var(--p-color-focus);outline-offset:2px}picture{display:block;width:min(30px,100%);height:min(40px,100%)}img{display:block;max-width:100%;max-height:100%;width:auto;height:auto}@media(forced-colors:active){a:focus-visible::before{outline-color:Highlight}}';
    }
    render() {
      return b2`
...
`;
  __decorateClass([
    n4()
  ], LitCrest.prototype, "href", 2);
  __decorateClass([
    n4()
  ], LitCrest.prototype, "target", 2);
  LitCrest = __decorateClass([
    t3("p-crest")
  ], LitCrest);
})();
