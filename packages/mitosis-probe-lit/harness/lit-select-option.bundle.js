...
\f\r"'\`<>=]|("|')|))|$)`, "g");
  ...
  // output/lit/src/SelectOption.ts
  var LitSelectOption = class extends i4 {
    get cssText() {
      ...
      let out = ":host{display:block;scroll-margin-block-start:calc(max(2px, var(--_p-select-option-a,1) * 6px) + 36px) !important;scroll-margin-block-end:max(2px, var(--_p-select-option-a,1) * 6px) !important}";
      if (disabled)
        out = ":host{display:block;opacity:0.4 !important;scroll-margin-block-start:calc(max(2px, var(--_p-select-option-a,1) * 6px) + 36px) !important;scroll-margin-block-end:max(2px, var(--_p-select-option-a,1) * 6px) !important}";
      out += ":host([hidden]){display:none !important}::slotted(img){font:var(--p-typescale-sm) var(--p-font-porsche-next) !important;width:auto !important;height:var(--p-leading-normal) !important;border-radius:var(--p-radius-sm) !important}:not(:defined,[data-ssr]){visibility:hidden}";
      if (disabled) {
        out += "@media(forced-colors:active){:host{opacity:1 !important;color:GrayText !important}}";
      }
      out += ".option{display:flex;gap:calc(11.2px * (var(--_p-select-option-a) - 0.64285714) + 4px);padding-block:calc(11.2px * (var(--_p-select-option-a) - 0.64285714) + 4px);padding-inline:var(--_p-select-option-b,calc(16.8px * (var(--_p-select-option-a) - 0.64285714) + 6px)) calc(16.8px * (var(--_p-select-option-a) - 0.64285714) + 6px);min-height:var(--p-leading-normal);font:var(--p-font-weight-normal) var(--p-typescale-sm) / var(--p-leading-normal) var(--p-font-porsche-next);color:var(--p-color-contrast-high);cursor:" + (disabled ? "not-allowed" : "pointer") + ";text-align:start;word-break:break-word;box-sizing:content-box;border-radius:var(--p-radius-sm);transition:background-color var(--p-transition-duration,var(--p-duration-sm)) var(--p-ease-in-out), color var(--p-transition-duration,var(--p-duration-sm)) var(--p-ease-in-out)}.option--highlighted{background:var(--p-color-frosted)}.option--highlighted,.option--selected{color:var(--p-color-primary)}.option--disabled{cursor:not-allowed}.option--hidden{display:none}.icon{margin-inline-start:auto}@media(forced-colors:active){.option--disabled{color:GrayText}.option--highlighted{forced-color-adjust:none;outline:2px solid Highlight;outline-offset:-2px}}";
      return out;
    }
    get isDisabled() {
    ...
    render() {
      ...
      const icon = selected ? b2`<p-icon class="icon" name="check" color="primary" aria-hidden="true"></p-icon>` : A;
      return b2`<div class="${cls.join(" ")}"><style .innerHTML="${this.cssText}"></style><slot></slot>${icon}</div>`;
    }
  };
  LitSelectOption.styles = i`
      :host {
          display: block;
        }
        :host([hidden]) {
...
`;
  __decorateClass([
    n4()
  ], LitSelectOption.prototype, "hidden", 2);
  __decorateClass([
    n4()
  ], LitSelectOption.prototype, "value", 2);
  __decorateClass([
    n4()
  ], LitSelectOption.prototype, "disabled", 2);
  __decorateClass([
    n4()
  ], LitSelectOption.prototype, "disabledParent", 2);
  __decorateClass([
    n4()
  ], LitSelectOption.prototype, "selected", 2);
  __decorateClass([
    n4()
  ], LitSelectOption.prototype, "highlighted", 2);
  LitSelectOption = __decorateClass([
    t3("lit-select-option")
  ], LitSelectOption);
})();
