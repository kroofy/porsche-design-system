...
\f\r"'\`<>=]|("|')|))|$)`, "g");
  ...
  // ../../components/mitosis/select-option/output/lit/SelectOption.ts
  var LitSelectOption = class extends i4 {
    ...
    render() {
      ...
      const icon = selected ? b2`<p-icon class="icon" name="check" source="http://localhost:3001/icons/check.8ba06be.svg" color="primary" aria-hidden="true"></p-icon>` : A;
