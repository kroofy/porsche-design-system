...
\f\r"'\`<>=]|("|')|))|$)`, "g");
  ...
  // output/lit/src/TagDismissible.ts
  var LitTagDismissible = class extends i4 {
    get cssText() {
    ...
    render() {
      return b2`<button type="button" aria-label=${this.ariaLabel || A}><style .innerHTML="${this.cssText}"></style><span class="sr-only">Remove:</span><span><span class="label">${this.labelText}</span><slot></slot></span><span class="icon"><p-icon name="close" aria-hidden="true"></p-icon></span></button>`;
    }
  };
  LitTagDismissible.styles = i`
      :host {
...
`;
  __decorateClass([
    n4()
  ], LitTagDismissible.prototype, "compact", 2);
  __decorateClass([
    n4()
  ], LitTagDismissible.prototype, "label", 2);
  __decorateClass([
    n4()
  ], LitTagDismissible.prototype, "aria", 2);
  LitTagDismissible = __decorateClass([
    t3("lit-tag-dismissible")
  ], LitTagDismissible);
})();
