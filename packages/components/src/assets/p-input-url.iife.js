...
\f\r"'\`<>=]|("|')|))|$)`, "g");
  ...
  LitInputUrl.styles = i`
      :host {
        ...
        :host(:dir(rtl)) input:placeholder-shown {
          direction: ltr;
        }
