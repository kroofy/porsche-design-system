...
export default class LitCarousel {
  ...
  @Input() description!: LitCarouselProps["description"];
  @Input() headingSize!: LitCarouselProps["headingSize"];
  @Input() width!: LitCarouselProps["width"];
  @Input() alignHeader!: LitCarouselProps["alignHeader"];
...
@NgModule({
  declarations: [LitCarousel],
  imports: [CommonModule],
  exports: [LitCarousel],
})
export class LitCarouselModule {}
