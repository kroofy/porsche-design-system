...
\f\r"'\`<>=]|("|')|))|$)`, "g");
  ...
  var LitSelectOption = class extends i4 {
    ...
    render() {
      ...
      return b2`<div class="${cls.join(" ")}"><slot></slot>${icon}</div>`;
    }
  };
  LitSelectOption.styles = i`
      :host {
          ...
          scroll-margin-block-start: calc(
            max(2px, var(--_p-select-option-a, 1) * 6px) + 36px
          ) !important;
          scroll-margin-block-end: max(
            2px,
            var(--_p-select-option-a, 1) * 6px
          ) !important;
        }
        :host([hidden]) {
        ...
        .option {
          ...
          padding-inline: var(
              --_p-select-option-b,
              calc(16.8px * (var(--_p-select-option-a) - 0.64285714) + 6px)
            )
            calc(16.8px * (var(--_p-select-option-a) - 0.64285714) + 6px);
