...
\f\r"'\`<>=]|("|')|))|$)`, "g");
  ...
  var LitOptgroup = class extends i4 {
    ...
    render() {
      const disabled = !!this.isDisabled;
      return b2`<div role="group" aria-labelledby="label" aria-disabled=${disabled ? "true" : A}><style .innerHTML="${this.cssText}"></style><span id="label" role="presentation">${this.labelText}</span><slot></slot></div>`;
    }
  };
...
`;
  __decorateClass([
    n4()
  ], LitOptgroup.prototype, "hidden", 2);
  __decorateClass([
    n4()
  ], LitOptgroup.prototype, "disabled", 2);
  __decorateClass([
    n4()
  ], LitOptgroup.prototype, "label", 2);
  LitOptgroup = __decorateClass([
    t3("lit-optgroup")
  ], LitOptgroup);
})();
