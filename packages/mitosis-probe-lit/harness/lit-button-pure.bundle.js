...
\f\r"'\`<>=]|("|')|))|$)`, "g");
  ...
  // output/lit/src/ButtonPure.ts
  var LitButtonPure = class extends i4 {
    get cssText() {
      const sizeMap = {
      ...
      const color = disabled ? "var(--p-color-contrast-low)" : colorMap[this.color || "primary"] || colorMap.primary;
      ...
      if (hasIcon) {
        ...
        out += ".label{position:relative;opacity:0}.icon{position:absolute;top:0;left:calc(50% - var(--p-leading-normal) / 2)}";
      } else {
      ...
      for (const bp of Object.keys(keys)) {
        ...
        out += "@media(min-width:" + minWidth[bp] + "px){:host{" + hostFor(st) + "}.root{gap:" + gapFor(h3) + ";justify-content:" + justFor(st) + ";align-items:" + alignItemsFor(st) + ";font-size:" + fontFor(s4) + "}.root::before{right:" + insetFor(h3) + ";left:" + insetFor(h3) + ";border-radius:" + radiusFor(h3) + "}.label{" + visFor(h3) + ";order:" + orderFor(al) + "}}";
      }
      return out;
    }
    get iconName() {
    ...
    render() {
      return b2`<button class="root" type=${this.buttonType || "submit"} aria-disabled=${this.ariaDisabled || A}><style .innerHTML="${this.cssText}"></style><p-icon class="icon" name=${this.iconName || A} source=${this.iconSrc || A} size="inherit" color="inherit" aria-hidden="true"></p-icon><p-spinner class="icon" size="inherit" color="inherit" aria-hidden="true"></p-spinner><span class="label"><slot></slot></span><span class="loading" id="loading" role="status">${this.loadingText}</span></button>`;
    }
  };
  LitButtonPure.styles = i`
      :host {
...
`;
  __decorateClass([
    n4()
  ], LitButtonPure.prototype, "disabled", 2);
  __decorateClass([
    n4()
  ], LitButtonPure.prototype, "loading", 2);
  __decorateClass([
    n4()
  ], LitButtonPure.prototype, "color", 2);
  __decorateClass([
    n4()
  ], LitButtonPure.prototype, "underline", 2);
  __decorateClass([
    n4()
  ], LitButtonPure.prototype, "active", 2);
  __decorateClass([
    n4()
  ], LitButtonPure.prototype, "icon", 2);
  __decorateClass([
    n4()
  ], LitButtonPure.prototype, "iconSource", 2);
  __decorateClass([
    n4()
  ], LitButtonPure.prototype, "size", 2);
  __decorateClass([
    n4()
  ], LitButtonPure.prototype, "stretch", 2);
  __decorateClass([
    n4()
  ], LitButtonPure.prototype, "hideLabel", 2);
  __decorateClass([
    n4()
  ], LitButtonPure.prototype, "alignLabel", 2);
  __decorateClass([
    n4()
  ], LitButtonPure.prototype, "type", 2);
  LitButtonPure = __decorateClass([
    t3("lit-button-pure")
  ], LitButtonPure);
})();
